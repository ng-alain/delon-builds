...
function pluginRTL(options) {
    return (tree) => __awaiter(this, void 0, void 0, function* () {
        ...
        return schematics_1.chain([schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files/rtl'), [schematics_1.move(`${project.sourceRoot}/app`), utils_1.overwriteIfExists(tree)])), fixImport()]);
    });
}
