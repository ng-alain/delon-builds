...
function setPackage(host, options) {
    // libs
    (options.type === 'add' ? json_1.addPackageToPackageJson : json_1.removePackageFromPackageJson)(host, ['classlist.js@DEP-9.0.1', 'web-animations-js@DEP-9.0.1'], 'dependencies');
    // scripts
