...
exports.createTestApp = exports.createAlainAndModuleApp = exports.createAlainApp = exports.createAlainRunner = exports.createNgRunner = exports.FILE_PREFIX = exports.APPNAME = void 0;
...
function createAlainAndModuleApp(name = 'trade', ngAddOptions) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        res.tree = yield res.runner.runSchematicAsync('module', { name, project: exports.APPNAME, routing: true }, res.tree).toPromise();
        return res;
    });
}
