...
function fixAnalyze() {
    return (tree, context) => {
        ...
        (0, utils_1.logStart)(context, `Usd source-map-explorer instead of webpack-bundle-analyzer`);
    };
}
function finished() {
...
function v11Rule() {
    return (tree) => __awaiter(this, void 0, void 0, function* () {
        project = (yield (0, utils_1.getProject)(tree)).project;
        return (0, schematics_1.chain)([
            fixVersion(),
            fixThirdVersion(),
            fixAnalyze(),
            (0, hmr_1.fixHmr)(project.sourceRoot),
            (0, layout_1.fixLayout)(project),
            finished()
        ]);
    });
}
