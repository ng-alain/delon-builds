...
declare namespace onboarding_component_d_exports {
...
export declare class OnboardingComponent implements OnDestroy {
  ...
  running: import("@angular/core").WritableSignal<boolean>;
  dir: Direction;
  popover: import("@angular/core").Signal<NzPopoverDirective>;
