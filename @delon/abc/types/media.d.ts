...
declare namespace media_component_d_exports {
  export { MediaComponent, MediaType };
}
export type MediaType = 'html5' | 'youtube' | 'video' | 'audio';
export declare class MediaComponent implements OnDestroy {
  private readonly el;
  ...
  private _p?;
  private videoEl?;
  readonly type: import("@angular/core").InputSignal<MediaType>;
  readonly source: import("@angular/core").InputSignal<string | Plyr.SourceInfo | undefined>;
  readonly options: import("@angular/core").InputSignal<Plyr.Options | undefined>;
  readonly delay: import("@angular/core").InputSignalWithTransform<number, unknown>;
  readonly ready: import("@angular/core").OutputEmitterRef<Plyr>;
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<MediaComponent, "media, [media]", ["mediaComponent"], {
    "type": {
      "alias": "type";
      "required": false;
      "isSignal": true;
