...
declare namespace range_directive_d_exports {
...
export declare class RangePickerDirective implements OnDestroy, AfterViewInit {
  ...
  private locale;
  readonly shortcut: import("@angular/core").InputSignalWithTransform<AlainDateRangePickerShortcut | null, string | AlainDateRangePickerShortcut | null>;
  readonly ngModelEnd: import("@angular/core").ModelSignal<any>;
  private get dp();
  private get srv();
  constructor();
  private cd;
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<RangePickerDirective, "nz-range-picker[extend]", ["extendRangePicker"], {
    "shortcut": {
      "alias": "shortcut";
      "required": false;
      "isSignal": true;
    ...
    "ngModelEnd": "ngModelEndChange";
  }, never, never, true, never>;
}
declare namespace range_shortcut_component_d_exports {
  export { RangePickerShortcutTplComponent };
}
export declare class RangePickerShortcutTplComponent {
  readonly tpl: import("@angular/core").Signal<TemplateRef<void>>;
