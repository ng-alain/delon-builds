...
export declare class ObserverSize {
  private readonly _obs;
  private readonly el;
  private readonly d$;
  readonly event: import("@angular/core").OutputEmitterRef<MutationRecord[]>;
  constructor();
  static ɵfac: i0.ɵɵFactoryDeclaration<ObserverSize, never>;
  static ɵdir: i0.ɵɵDirectiveDeclaration<ObserverSize, "[observeSize]", ["observeSize"], {}, {
    "event": "observeSize";
