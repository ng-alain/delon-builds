...
import { AfterViewInit, ElementRef, EnvironmentProviders, EventEmitter, OnChanges, OnInit, SimpleChange, SimpleChanges, TemplateRef, TrackByFunction } from "@angular/core";
import { Observable } from "rxjs";
import { ThemeType } from "@ant-design/icons-angular";
import { CellOptions } from "@delon/abc/cell";
import { ACLCanType } from "@delon/acl";
import { DatePipe, DrawerHelperOptions, ModalHelperOptions, STLocaleData, YNMode, YNPipe, _HttpClient } from "@delon/theme";
...
import { NzTableComponent, NzTablePaginationType, NzTableSortOrder } from "ng-zorro-antd/table";
...
declare namespace st_component_d_exports {
  export { STComponent, STTdComponent };
}
declare class STTdComponent {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<STTdComponent, "st-td", never, {
    "c": {
      "alias": "c";
      "required": false;
    };
...
export declare class STComponent implements AfterViewInit, OnChanges {
  ...
  _widthConfig: string[];
  locale: import("@angular/core").Signal<import("@delon/theme").STLocaleData>;
  _loading: boolean;
  _data: STData[];
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<STComponent, "st", ["st"], {
    "req": {
      "alias": "req";
      "required": false;
    };
    ...
    "expandRowByClick": {
      "alias": "expandRowByClick";
      "required": false;
    };
    "expandAccordion": {
      "alias": "expandAccordion";
      "required": false;
    };
    "expand": {
      "alias": "expand";
    ...
    "responsiveHideHeaderFooter": {
      "alias": "responsiveHideHeaderFooter";
      "required": false;
    };
    "virtualScroll": {
      "alias": "virtualScroll";
    ...
    "virtualItemSize": {
      "alias": "virtualItemSize";
      "required": false;
    };
    "virtualMaxBufferPx": {
      "alias": "virtualMaxBufferPx";
      "required": false;
    };
    "virtualMinBufferPx": {
      "alias": "virtualMinBufferPx";
      "required": false;
    };
    "customRequest": {
      "alias": "customRequest";
...
export declare class STDataSource {
  ...
  private getValues;
  private getSum;
  static ɵfac: i0.ɵɵFactoryDeclaration<STDataSource, [null, {
    host: true;
  }, {
    host: true;
  }, {
...
declare namespace st_widget_host_directive_d_exports {
...
export declare class STWidgetHostDirective implements OnInit {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<STWidgetHostDirective, "[st-widget-host]", never, {
    "record": {
      "alias": "record";
      "required": false;
    };
...
declare namespace st_row_directive_d_exports {
  export { STRowDirective, STRowSource };
}
...
export declare class STRowDirective implements OnInit {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<STRowDirective, "[st-row]", never, {
    "id": {
      "alias": "st-row";
      "required": false;
    };
