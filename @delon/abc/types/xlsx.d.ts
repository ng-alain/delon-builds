...
declare namespace xlsx_directive_d_exports {
  export { XlsxDirective };
}
export declare class XlsxDirective {
  private readonly srv;
  readonly xlsx: import("@angular/core").InputSignal<XlsxExportOptions>;
  protected _click(): void;
  static ɵfac: i0.ɵɵFactoryDeclaration<XlsxDirective, never>;
  static ɵdir: i0.ɵɵDirectiveDeclaration<XlsxDirective, "[xlsx]", ["xlsx"], {
    "xlsx": {
      "alias": "xlsx";
      "required": true;
      "isSignal": true;
