...
import { CurrencyCNYOptions, CurrencyFormatOptions, CurrencyMegaOptions, FormatMaskOption } from "@delon/util/format";
...
declare namespace cell_component_d_exports {
...
export declare class CellComponent {
  ...
  private readonly el;
  private d$;
  protected _text: import("@angular/core").WritableSignal<string | number | SafeValue | string[]>;
  protected _unit: import("@angular/core").WritableSignal<string | undefined>;
  protected _res: import("@angular/core").WritableSignal<CellTextResult | undefined>;
  protected showDefault: import("@angular/core").Signal<boolean>;
  ...
  protected isText: import("@angular/core").Signal<boolean>;
  constructor();
  private setClass;
  protected _link(e: Event): void;
  protected _showImg(img: string): void;
  static ɵfac: i0.ɵɵFactoryDeclaration<CellComponent, never>;
  static ɵcmp: i0.ɵɵComponentDeclaration<CellComponent, "cell, [cell]", ["cell"], {
    "value": {
      "alias": "value";
      "required": false;
      "isSignal": true;
...
declare namespace cell_host_directive_d_exports {
  export { CellHostDirective };
}
export declare class CellHostDirective {
  private readonly srv;
  private readonly vcr;
  readonly data: import("@angular/core").InputSignal<CellTextResult>;
  constructor();
  static ɵfac: i0.ɵɵFactoryDeclaration<CellHostDirective, never>;
  static ɵdir: i0.ɵɵDirectiveDeclaration<CellHostDirective, "[cell-widget-host]", never, {
    "data": {
      "alias": "data";
      "required": true;
      "isSignal": true;
