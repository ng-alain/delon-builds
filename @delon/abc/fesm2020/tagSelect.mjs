...
TagSelectModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: TagSelectModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
TagSelectModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: TagSelectModule, declarations: [TagSelectComponent], imports: [CommonModule, NzIconModule, DelonLocaleModule], exports: [TagSelectComponent] });
TagSelectModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: TagSelectModule, imports: [[CommonModule, NzIconModule, DelonLocaleModule]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.1", ngImport: i0, type: TagSelectModule, decorators: [{
            type: NgModule,
            args: [{
...
//# sourceMappingURL=tagSelect.mjs.map
