...
import { ChangeDetectionStrategy, Component, Input, NgModule, ViewEncapsulation, afterNextRender, booleanAttribute, computed, inject, input, numberAttribute, viewChild } from "@angular/core";
...
var SVTitleComponent = class SVTitleComponent {
	parentComp = inject(SVContainerComponent, {
		host: true,
		optional: true
	});
	paddingValue = computed(() => this.parentComp.gutter() / 2, ...ngDevMode ? [{ debugName: "paddingValue" }] : /* istanbul ignore next */ []);
	constructor() {
		if (this.parentComp == null) throw new Error(`[sv-title] must include 'sv-container' component`);
	}
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
		type: SVTitleComponent,
		deps: [],
...
var SVContainerComponent = class SVContainerComponent {
	...
	default = input(true, {
		...ngDevMode ? { debugName: "default" } : /* istanbul ignore next */ {},
...
var SVValueComponent = class SVValueComponent {
	prefix;
	unit;
	tooltip;
	size = "default";
...
const prefixCls = `sv`;
var SVComponent = class SVComponent {
	parentComp = inject(SVContainerComponent, {
		host: true,
		optional: true
	});
	rep = inject(ResponsiveService);
	conEl = viewChild.required("conEl", ...ngDevMode ? [{ debugName: "conEl" }] : /* istanbul ignore next */ []);
	_noColon = computed(() => {
	...
	unit = input(...ngDevMode ? [void 0, { debugName: "unit" }] : /* istanbul ignore next */ []);
	col = input(null, {
		...ngDevMode ? { debugName: "col" } : /* istanbul ignore next */ {},
	...
	constructor() {
		if (this.parentComp == null) throw new Error(`[sv] must include 'sv-container' component`);
		afterNextRender(() => {
			this.checkContent();
		});
	}
