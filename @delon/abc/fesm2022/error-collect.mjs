...
import { ChangeDetectionStrategy, Component, DestroyRef, ElementRef, NgModule, ViewEncapsulation, inject, input, numberAttribute, signal } from "@angular/core";
import { takeUntilDestroyed } from "@angular/core/rxjs-interop";
import { interval } from "rxjs";
import { AlainConfigService } from "@delon/util/config";
import { NzIconDirective, NzIconModule } from "ng-zorro-antd/icon";
var ErrorCollectComponent = class ErrorCollectComponent {
	...
	freq = input(0, {
		...ngDevMode ? { debugName: "freq" } : /* istanbul ignore next */ {},
	...
	_click() {
		...
		(this.findParent(els[0], "[nz-form-control]") ?? els[0]).scrollIntoView(true);
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: {
			...
			offsetTop: {
				classPropertyName: "offsetTop",
				publicName: "offsetTop",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			}
...
var ErrorCollectModule = class ErrorCollectModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
		type: ErrorCollectModule,
		deps: [],
