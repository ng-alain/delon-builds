...
import { ChangeDetectionStrategy, Component, NgModule, ViewEncapsulation, afterNextRender, booleanAttribute, inject, input } from "@angular/core";
...
var FooterToolbarComponent = class FooterToolbarComponent {
	bodyCls = inject(DOCUMENT).querySelector("body")?.classList;
	errorCollect = input(false, {
		...ngDevMode ? { debugName: "errorCollect" } : /* istanbul ignore next */ {},
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: {
			errorCollect: {
				classPropertyName: "errorCollect",
				publicName: "errorCollect",
				isSignal: true,
				isRequired: false,
		...
		host: { classAttribute: "footer-toolbar" },
  ...
  `,
		...
		dependencies: [{
			...
			kind: "component",
			type: ErrorCollectComponent,
			selector: "error-collect, [error-collect]",
			inputs: ["freq", "offsetTop"],
...
var FooterToolbarModule = class FooterToolbarModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
		type: FooterToolbarModule,
		deps: [],
