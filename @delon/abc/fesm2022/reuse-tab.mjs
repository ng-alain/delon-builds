...
class ReuseTabContextMenuComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextMenuComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.1.7", type: ReuseTabContextMenuComponent, isStandalone: true, selector: "reuse-tab-context-menu", inputs: { i18n: "i18n", item: "item", event: "event", customContextMenu: "customContextMenu" }, outputs: { close: "close" }, host: { listeners: { "document:click": "closeMenu($event)", "document:contextmenu": "closeMenu($event)" } }, ngImport: i0, template: `
    <ul nz-menu>
      @if (item.active) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextMenuComponent, decorators: [{
            type: Component,
            args: [{
...
class ReuseTabContextService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextService, decorators: [{
            type: Injectable
        }] });
...
class ReuseTabContextComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.1.7", type: ReuseTabContextComponent, isStandalone: true, selector: "reuse-tab-context", inputs: { i18n: "i18n" }, outputs: { change: "change" }, ngImport: i0, template: ``, isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextComponent, decorators: [{
            type: Component,
            args: [{
...
class ReuseTabContextDirective {
    srv = inject(ReuseTabContextService);
    item = input.required({ ...(ngDevMode ? { debugName: "item" } : /* istanbul ignore next */ {}), alias: 'reuse-tab-context-menu' });
    customContextMenu = input.required(/* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "customContextMenu" }] : /* istanbul ignore next */ []));
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.1.7", type: ReuseTabContextDirective, isStandalone: true, selector: "[reuse-tab-context-menu]", inputs: { item: { classPropertyName: "item", publicName: "reuse-tab-context-menu", isSignal: true, isRequired: true, transformFunction: null }, customContextMenu: { classPropertyName: "customContextMenu", publicName: "customContextMenu", isSignal: true, isRequired: true, transformFunction: null } }, host: { listeners: { "contextmenu": "_onContextMenu($event)" } }, exportAs: ["reuseTabContextMenu"], ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabContextDirective, decorators: [{
            type: Directive,
            args: [{
                    selector: '[reuse-tab-context-menu]',
...
class ReuseTabService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabService });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabService, decorators: [{
            type: Injectable
        }], ctorParameters: () => [] });
...
class ReuseTabComponent {
    ...
    stateKey = inject(REUSE_TAB_STORAGE_KEY);
    stateSrv = inject(REUSE_TAB_STORAGE_STATE);
    tabset = viewChild.required(NzTabsComponent, /* @ts-ignore */
    ...
    item;
    pos = signal(0, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "pos" }] : /* istanbul ignore next */ []));
    // #region fields
    mode = input(ReuseTabMatchMode.Menu, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "mode" }] : /* istanbul ignore next */ []));
    i18n = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "i18n" }] : /* istanbul ignore next */ []));
    ...
    tabMaxWidth = input(undefined, { ...(ngDevMode ? { debugName: "tabMaxWidth" } : /* istanbul ignore next */ {}), transform: numberAttribute });
    excludes = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "excludes" }] : /* istanbul ignore next */ []));
    allowClose = input(true, { ...(ngDevMode ? { debugName: "allowClose" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    keepingScroll = input(false, { ...(ngDevMode ? { debugName: "keepingScroll" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    storageState = input(false, { ...(ngDevMode ? { debugName: "storageState" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    keepingScrollContainer = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "keepingScrollContainer" }] : /* istanbul ignore next */ []));
    customContextMenu = input([], /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "customContextMenu" }] : /* istanbul ignore next */ []));
    tabBarExtraContent = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "tabBarExtraContent" }] : /* istanbul ignore next */ []));
    tabBarGutter = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "tabBarGutter" }] : /* istanbul ignore next */ []));
    tabBarStyle = input(null, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "tabBarStyle" }] : /* istanbul ignore next */ []));
    tabType = input('line', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "tabType" }] : /* istanbul ignore next */ []));
    routeParamMatchMode = input('strict', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "routeParamMatchMode" }] : /* istanbul ignore next */ []));
    disabled = input(false, { ...(ngDevMode ? { debugName: "disabled" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    titleRender = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "titleRender" }] : /* istanbul ignore next */ []));
    canClose = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "canClose" }] : /* istanbul ignore next */ []));
    trackByFn = input(item => item.url, /* @ts-ignore */
  ...
  `, isInline: true, dependencies: [{ kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "component", type: NzTabsComponent, selector: "nz-tabs", inputs: ["nzSelectedIndex", "nzTabPosition", "nzTabBarExtraContent", "nzCanDeactivate", "nzAddIcon", "nzTabBarStyle", "nzType", "nzSize", "nzAnimated", "nzTabBarGutter", "nzHideAdd", "nzCentered", "nzHideAll", "nzLinkRouter", "nzLinkExact", "nzDestroyInactiveTabPane", "nzIndicator"], outputs: ["nzSelectChange", "nzSelectedIndexChange", "nzTabListScroll", "nzClose", "nzAdd"], exportAs: ["nzTabs"] }, { kind: "component", type: NzTabComponent, selector: "nz-tab", inputs: ["nzTitle", "nzClosable", "nzCloseIcon", "nzDisabled", "nzForceRender"], outputs: ["nzSelect", "nzDeselect", "nzClick", "nzContextmenu"], exportAs: ["nzTab"] }, { kind: "directive", type: ReuseTabContextDirective, selector: "[reuse-tab-context-menu]", inputs: ["reuse-tab-context-menu", "customContextMenu"], exportAs: ["reuseTabContextMenu"] }, { kind: "component", type: ReuseTabContextComponent, selector: "reuse-tab-context", inputs: ["i18n"], outputs: ["change"] }, { kind: "directive", type: NzIconDirective, selector: "nz-icon,[nz-icon]", inputs: ["nzType", "nzTheme", "nzTwotoneColor", "nzSpin", "nzRotate", "nzIconfont", "aria-label"], exportAs: ["nzIcon"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabComponent, decorators: [{
            type: Component,
            args: [{
...
class ReuseTabModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabModule, imports: [CommonModule,
            RouterModule,
            DelonLocaleModule,
            NzMenuModule,
            NzTabsModule,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabModule, providers: [
            {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: ReuseTabModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
