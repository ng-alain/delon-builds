...
import { ChangeDetectionStrategy, Component, Injectable, NgModule, ViewEncapsulation, inject } from "@angular/core";
...
var LoadingDefaultComponent = class LoadingDefaultComponent {
	options;
	dir = "ltr";
	get icon() {
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		host: {
			properties: { "class.loading-default-rtl": "dir === 'rtl'" },
			classAttribute: "loading-default"
		},
		ngImport: i0,
		template: `
...
var LoadingService = class LoadingService {
	...
	constructor() {
		...
		this.loading$ = this.n$.asObservable().pipe(debounce(() => timer(this.opt.delay))).subscribe(() => this.create());
	}
	create() {
...
var LoadingModule = class LoadingModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
