...
import { Component, ChangeDetectionStrategy, ViewEncapsulation, ViewChild, Input, inject, DestroyRef, Inject, Optional, ContentChildren, NgModule } from '@angular/core';
