...
import { ChangeDetectionStrategy, Component, NgModule, ViewEncapsulation, booleanAttribute, computed, contentChildren, inject, input, viewChild } from "@angular/core";
import { DomSanitizer } from "@angular/platform-browser";
import { Router, RouterModule } from "@angular/router";
import { WINDOW } from "@delon/util/token";
var GlobalFooterItemComponent = class GlobalFooterItemComponent {
	host = viewChild.required("host", ...ngDevMode ? [{ debugName: "host" }] : /* istanbul ignore next */ []);
	href = input(...ngDevMode ? [void 0, { debugName: "href" }] : /* istanbul ignore next */ []);
	blankTarget = input(false, {
		...ngDevMode ? { debugName: "blankTarget" } : /* istanbul ignore next */ {},
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: {
			...
			blankTarget: {
				classPropertyName: "blankTarget",
				publicName: "blankTarget",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			}
...
var GlobalFooterComponent = class GlobalFooterComponent {
	...
	linkHtmls = computed(() => {
		return this.links().map((item) => {
			if (typeof item.title === "string") item.title = this.dom.bypassSecurityTrustHtml(item.title);
			return item;
		});
	...
	to(item) {
		...
		if (!href) return;
		if (typeof item.blankTarget === "boolean" ? item.blankTarget : item.blankTarget?.()) {
			this.win.open(href);
			return;
		}
		if (/^https?:\/\//.test(href)) this.win.location.href = href;
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		host: {
			properties: { "class.global-footer-rtl": "dir() === 'rtl'" },
			classAttribute: "global-footer"
		},
		queries: [{
			propertyName: "items",
			predicate: GlobalFooterItemComponent,
			isSignal: true
		}],
  ...
  `,
	...
	propDecorators: {
		...
		items: [{
			...
			args: [i0.forwardRef(() => GlobalFooterItemComponent), { isSignal: true }]
		}]
	}
});
const COMPONENTS = [GlobalFooterComponent, GlobalFooterItemComponent];
var GlobalFooterModule = class GlobalFooterModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
