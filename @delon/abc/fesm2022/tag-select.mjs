...
import { ChangeDetectionStrategy, Component, NgModule, ViewEncapsulation, booleanAttribute, inject, input, output, signal } from "@angular/core";
import { DelonLocaleModule, DelonLocaleService } from "@delon/theme";
import { NzIconDirective, NzIconModule } from "ng-zorro-antd/icon";
import { CommonModule } from "@angular/common";
var TagSelectComponent = class TagSelectComponent {
...
var TagSelectModule = class TagSelectModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
		type: TagSelectModule,
		deps: [],
