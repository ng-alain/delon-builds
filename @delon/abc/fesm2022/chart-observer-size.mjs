...
import { DestroyRef, Directive, ElementRef, Injectable, NgModule, afterNextRender, inject, output } from "@angular/core";
import { takeUntilDestroyed } from "@angular/core/rxjs-interop";
import { Observable, Subject } from "rxjs";
var SizeObserver = class SizeObserver {
...
var ObserverSize = class ObserverSize {
	...
	constructor() {
		afterNextRender(() => {
			this._obs.observe(this.el).pipe(takeUntilDestroyed(this.d$)).subscribe((res) => this.event.emit(res));
		});
	}
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
