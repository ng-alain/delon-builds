...
import { ChangeDetectionStrategy, Component, NgModule, ViewEncapsulation, booleanAttribute, effect, inject, input, numberAttribute, output, signal } from "@angular/core";
...
var NoticeIconTabComponent = class NoticeIconTabComponent {
...
var NoticeIconComponent = class NoticeIconComponent {
	...
	popoverVisible = input(false, {
		...ngDevMode ? { debugName: "popoverVisible" } : /* istanbul ignore next */ {},
		transform: booleanAttribute
	});
	btnClass = input(...ngDevMode ? [void 0, { debugName: "btnClass" }] : /* istanbul ignore next */ []);
	btnIconClass = input(...ngDevMode ? [void 0, { debugName: "btnIconClass" }] : /* istanbul ignore next */ []);
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: {
			...
			popoverVisible: {
				classPropertyName: "popoverVisible",
				publicName: "popoverVisible",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			btnClass: {
				classPropertyName: "btnClass",
				publicName: "btnClass",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			...
			btnIconClass: {
				classPropertyName: "btnIconClass",
				publicName: "btnIconClass",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			centered: {
				classPropertyName: "centered",
				publicName: "centered",
				isSignal: true,
				isRequired: false,
				transformFunction: null
...
var NoticeIconModule = class NoticeIconModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
		type: NoticeIconModule,
		deps: [],
