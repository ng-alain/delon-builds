...
class NoticeIconComponent {
    ...
    select = new EventEmitter();
    clear = new EventEmitter();
    popoverVisibleChange = new EventEmitter();
    get overlayCls() {
