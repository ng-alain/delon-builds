...
class EllipsisComponent {
    ...
    orgEl = viewChild.required('orgEl', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "orgEl" }] : /* istanbul ignore next */ []));
    shadowOrgEl = viewChild('shadowOrgEl', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "shadowOrgEl" }] : /* istanbul ignore next */ []));
    shadowTextEl = viewChild('shadowTextEl', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "shadowTextEl" }] : /* istanbul ignore next */ []));
    orgHtml = signal(null, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "orgHtml" }] : /* istanbul ignore next */ []));
    type = signal('default', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "type" }] : /* istanbul ignore next */ []));
    cls = signal({}, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "cls" }] : /* istanbul ignore next */ []));
    text = signal('', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "text" }] : /* istanbul ignore next */ []));
    targetCount = 0;
    tooltip = input(false, { ...(ngDevMode ? { debugName: "tooltip" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    length = input(null, { ...(ngDevMode ? { debugName: "length" } : /* istanbul ignore next */ {}), transform: (v) => (v == null ? null : numberAttribute(v)) });
    lines = input(null, { ...(ngDevMode ? { debugName: "lines" } : /* istanbul ignore next */ {}), transform: (v) => (v == null ? null : numberAttribute(v)) });
    fullWidthRecognition = input(false, { ...(ngDevMode ? { debugName: "fullWidthRecognition" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    tail = input('...', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "tail" }] : /* istanbul ignore next */ []));
    get linsWord() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: EllipsisComponent, decorators: [{
            type: Component,
            args: [{
                    selector: 'ellipsis',
                    exportAs: 'ellipsis',
...
class EllipsisModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: EllipsisModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.1.4", ngImport: i0, type: EllipsisModule, imports: [CommonModule, ObserversModule, NzTooltipModule, EllipsisComponent], exports: [EllipsisComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: EllipsisModule, imports: [CommonModule, ObserversModule, NzTooltipModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: EllipsisModule, decorators: [{
            type: NgModule,
            args: [{
