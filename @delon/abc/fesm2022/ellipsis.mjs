...
class EllipsisComponent {
    ...
    shadowOrgEl = viewChild('shadowOrgEl', ...(ngDevMode ? [{ debugName: "shadowOrgEl" }] : /* istanbul ignore next */ []));
    shadowTextEl = viewChild('shadowTextEl', ...(ngDevMode ? [{ debugName: "shadowTextEl" }] : /* istanbul ignore next */ []));
    orgHtml = signal(null, ...(ngDevMode ? [{ debugName: "orgHtml" }] : /* istanbul ignore next */ []));
    type = signal('default', ...(ngDevMode ? [{ debugName: "type" }] : /* istanbul ignore next */ []));
    cls = signal({}, ...(ngDevMode ? [{ debugName: "cls" }] : /* istanbul ignore next */ []));
    ...
    tail = input('...', ...(ngDevMode ? [{ debugName: "tail" }] : /* istanbul ignore next */ []));
    get linsWord() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.11", ngImport: i0, type: EllipsisComponent, decorators: [{
            type: Component,
            args: [{
                    selector: 'ellipsis',
                    exportAs: 'ellipsis',
...
class EllipsisModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "21.2.11", ngImport: i0, type: EllipsisModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "21.2.11", ngImport: i0, type: EllipsisModule, imports: [CommonModule, ObserversModule, NzTooltipModule, EllipsisComponent], exports: [EllipsisComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "21.2.11", ngImport: i0, type: EllipsisModule, imports: [CommonModule, ObserversModule, NzTooltipModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.2.11", ngImport: i0, type: EllipsisModule, decorators: [{
            type: NgModule,
            args: [{
