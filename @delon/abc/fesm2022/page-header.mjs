...
import { ChangeDetectionStrategy, Component, NgModule, Renderer2, TemplateRef, ViewEncapsulation, afterNextRender, booleanAttribute, computed, effect, inject, input, numberAttribute, signal, viewChild } from "@angular/core";
import { takeUntilDestroyed } from "@angular/core/rxjs-interop";
import { NavigationEnd, Router, RouterLink, RouterModule } from "@angular/router";
import { filter, merge } from "rxjs";
import { ReuseTabService } from "@delon/abc/reuse-tab";
import { ALAIN_I18N_TOKEN, DelonLocaleService, MenuService, SettingsService, TitleService } from "@delon/theme";
...
var PageHeaderComponent = class PageHeaderComponent {
	...
	conTpl = viewChild.required("conTpl", ...ngDevMode ? [{ debugName: "conTpl" }] : /* istanbul ignore next */ []);
	...
	titleSub = input(...ngDevMode ? [void 0, { debugName: "titleSub" }] : /* istanbul ignore next */ []);
	...
	wide = input(false, {
		...ngDevMode ? { debugName: "wide" } : /* istanbul ignore next */ {},
		transform: booleanAttribute
	});
	home = input(...ngDevMode ? [void 0, { debugName: "home" }] : /* istanbul ignore next */ []);
	homeLink = input("/", ...ngDevMode ? [{ debugName: "homeLink" }] : /* istanbul ignore next */ []);
	homeI18n = input(...ngDevMode ? [void 0, { debugName: "homeI18n" }] : /* istanbul ignore next */ []);
	autoBreadcrumb = input(true, {
		...ngDevMode ? { debugName: "autoBreadcrumb" } : /* istanbul ignore next */ {},
		transform: booleanAttribute
	});
	autoTitle = input(true, {
		...ngDevMode ? { debugName: "autoTitle" } : /* istanbul ignore next */ {},
		transform: booleanAttribute
	});
	syncTitle = input(true, {
		...ngDevMode ? { debugName: "syncTitle" } : /* istanbul ignore next */ {},
		transform: booleanAttribute
	});
	fixed = input(false, {
	...
	fixedOffsetTop = input(64, {
		...ngDevMode ? { debugName: "fixedOffsetTop" } : /* istanbul ignore next */ {},
		transform: numberAttribute
	});
	breadcrumb = input(null, ...ngDevMode ? [{ debugName: "breadcrumb" }] : /* istanbul ignore next */ []);
	recursiveBreadcrumb = input(false, {
		...ngDevMode ? { debugName: "recursiveBreadcrumb" } : /* istanbul ignore next */ {},
		transform: booleanAttribute
	});
	...
	constructor() {
		this.cogSrv.attach(this, "pageHeader", { home: this.locale.home });
		this.settings.notify.pipe(takeUntilDestroyed(), filter((w) => this.affix() != null && w.type === "layout" && w.name === "collapsed")).subscribe(() => this.affix()?.updatePosition({}));
		...
		merge(...obsList).pipe(takeUntilDestroyed()).subscribe(() => this.refresh());
		effect(() => this.refresh());
	...
	refresh() {
		...
		} else title = this.titleIsTpl() ? "" : this.title();
		this.titleText.set(title);
		if (title && this.syncTitle()) {
			this.titleSrv.setTitle(title);
			if (this.reuseSrv) this.reuseSrv.title = title;
		}
		this.genBreadcrumb();
	}
	genBreadcrumb() {
	...
	checkContent() {
		...
		if (isEmpty(el)) this.renderer.setAttribute(el, "hidden", "");
		else this.renderer.removeAttribute(el, "hidden");
	}
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: {
			...
			autoBreadcrumb: {
				classPropertyName: "autoBreadcrumb",
				publicName: "autoBreadcrumb",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			autoTitle: {
				classPropertyName: "autoTitle",
				publicName: "autoTitle",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			syncTitle: {
				classPropertyName: "syncTitle",
				publicName: "syncTitle",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			fixed: {
				classPropertyName: "fixed",
				publicName: "fixed",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			...
			fixedOffsetTop: {
				classPropertyName: "fixedOffsetTop",
				publicName: "fixedOffsetTop",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			breadcrumb: {
				classPropertyName: "breadcrumb",
				publicName: "breadcrumb",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			recursiveBreadcrumb: {
				classPropertyName: "recursiveBreadcrumb",
				publicName: "recursiveBreadcrumb",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			logo: {
				classPropertyName: "logo",
				publicName: "logo",
				isSignal: true,
				isRequired: false,
				transformFunction: null
...
i0.ɵɵngDeclareClassMetadata({
  ...
  `,
	...
	propDecorators: {
		conTpl: [{
			type: i0.ViewChild,
			args: ["conTpl", { isSignal: true }]
		}],
		affix: [{
			type: i0.ViewChild,
			args: [i0.forwardRef(() => NzAffixComponent), { isSignal: true }]
		}],
		titleSub: [{
			type: i0.Input,
			args: [{
...
var PageHeaderModule = class PageHeaderModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
