...
class PageHeaderComponent {
    ...
    conTpl = viewChild.required('conTpl', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "conTpl" }] : /* istanbul ignore next */ []));
    affix = viewChild(NzAffixComponent, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "affix" }] : /* istanbul ignore next */ []));
    isBrowser = inject(Platform).isBrowser;
    dir = inject(Directionality).valueSignal;
    get menus() {
        return this.menuSrv.getPathByUrl(this.router.url, this.recursiveBreadcrumb());
    }
    paths = signal([], /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "paths" }] : /* istanbul ignore next */ []));
    titleIsTpl = computed(() => this.title() instanceof TemplateRef, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "titleIsTpl" }] : /* istanbul ignore next */ []));
    titleText = signal(null, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "titleText" }] : /* istanbul ignore next */ []));
    titleSub = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "titleSub" }] : /* istanbul ignore next */ []));
    // #region fields
    ...
    homeLink = input('/', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "homeLink" }] : /* istanbul ignore next */ []));
    homeI18n = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "homeI18n" }] : /* istanbul ignore next */ []));
    ...
    breadcrumb = input(null, /* @ts-ignore */
    ...
    logo = input(null, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "logo" }] : /* istanbul ignore next */ []));
    action = input(null, /* @ts-ignore */
    ...
    extra = input(null, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "extra" }] : /* istanbul ignore next */ []));
    tab = input(null, /* @ts-ignore */
...
class PageHeaderModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: PageHeaderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.1.4", ngImport: i0, type: PageHeaderModule, imports: [CommonModule,
            RouterModule,
            ObserversModule,
            NzAffixModule,
            NzSkeletonModule,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: PageHeaderModule, imports: [CommonModule,
            RouterModule,
            ObserversModule,
            NzAffixModule,
            NzSkeletonModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: PageHeaderModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
