...
import { inject, Renderer2, ChangeDetectorRef, DestroyRef, TemplateRef, booleanAttribute, numberAttribute, Component, ChangeDetectionStrategy, ViewEncapsulation, ViewChild, Input, NgModule } from '@angular/core';
