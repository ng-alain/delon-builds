...
import { ChangeDetectionStrategy, Component, DestroyRef, Injector, NgModule, TemplateRef, ViewEncapsulation, afterNextRender, booleanAttribute, computed, contentChild, effect, inject, input, linkedSignal, numberAttribute, runInInjectionContext, signal, viewChild } from "@angular/core";
...
var SETitleComponent = class SETitleComponent {
	parentComp = inject(SEContainerComponent, {
		host: true,
		optional: true
	});
	constructor() {
		if (this.parentComp == null) throw new Error(`[se-title] must include 'se-container' component`);
	}
...
var SEContainerComponent = class SEContainerComponent {
	cogSrv = inject(AlainConfigService);
	colInCon = input(null, {
		...ngDevMode ? { debugName: "colInCon" } : /* istanbul ignore next */ {},
		transform: (v) => v == null ? null : numberAttribute(v, null),
		alias: "se-container"
	});
	labelWidth = input(150, {
	...
	gutter = input(32, {
		...ngDevMode ? { debugName: "gutter" } : /* istanbul ignore next */ {},
	...
	firstVisual = input(false, {
		...ngDevMode ? { debugName: "firstVisual" } : /* istanbul ignore next */ {},
		transform: booleanAttribute
	});
	ingoreDirty = input(false, {
		...ngDevMode ? { debugName: "ingoreDirty" } : /* istanbul ignore next */ {},
		transform: booleanAttribute
	});
	line = input(false, {
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: {
			colInCon: {
				classPropertyName: "colInCon",
				publicName: "se-container",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			labelWidth: {
				classPropertyName: "labelWidth",
				publicName: "labelWidth",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			col: {
				classPropertyName: "col",
				publicName: "col",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			...
			ingoreDirty: {
				classPropertyName: "ingoreDirty",
				publicName: "ingoreDirty",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
		...
		host: {
			...
			classAttribute: "ant-row se__container"
		},
...
const prefixCls = `se`;
let nextUniqueId = 0;
var SEComponent = class SEComponent {
	parentComp = inject(SEContainerComponent, {
		host: true,
		optional: true
	});
	...
	contentElement = viewChild.required("contentElement", ...ngDevMode ? [{ debugName: "contentElement" }] : /* istanbul ignore next */ []);
	onceFlag = false;
	bindModel$;
	empty = signal(false, ...ngDevMode ? [{ debugName: "empty" }] : /* istanbul ignore next */ []);
	optional = input(...ngDevMode ? [void 0, { debugName: "optional" }] : /* istanbul ignore next */ []);
	optionalHelp = input(...ngDevMode ? [void 0, { debugName: "optionalHelp" }] : /* istanbul ignore next */ []);
	optionalHelpColor = input(...ngDevMode ? [void 0, { debugName: "optionalHelpColor" }] : /* istanbul ignore next */ []);
	error = input(...ngDevMode ? [void 0, { debugName: "error" }] : /* istanbul ignore next */ []);
	extra = input(...ngDevMode ? [void 0, { debugName: "extra" }] : /* istanbul ignore next */ []);
	...
	controlClass = input(...ngDevMode ? [void 0, { debugName: "controlClass" }] : /* istanbul ignore next */ []);
	line = input(null, {
		...ngDevMode ? { debugName: "line" } : /* istanbul ignore next */ {},
		transform: (v) => v == null ? null : booleanAttribute(v)
	});
	labelWidth = input(null, {
		...ngDevMode ? { debugName: "labelWidth" } : /* istanbul ignore next */ {},
		transform: (v) => v == null ? null : numberAttribute(v)
	});
	noColon = input(null, {
	...
	cls = computed(() => {
		...
		if (this.line() || parent.line()) ret.push(`${prefixCls}__line`);
		return ret;
	...
	constructor() {
		if (this.parentComp == null) throw new Error(`[se] must include 'se-container' component`);
		toObservable(this.parentComp.errors).pipe(takeUntilDestroyed(), map((ls) => ls.find((w) => this.ngControl()?.name === w.name)), filter((w) => w != null)).subscribe((item) => {
		...
		effect(() => {
			...
			this.bindModel$ = control.statusChanges.pipe(takeUntilDestroyed(this.destroy$)).subscribe((res) => this.updateStatus(res === "INVALID"));
			...
			if (controlEl) {
				if (controlEl.id) this._id.set(controlEl.id);
				else {
			...
			if (this.required() !== true) {
				...
				if (required !== true) required = (control?._rawValidators).find((w) => w instanceof RequiredValidator) != null;
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: {
			...
			optionalHelp: {
				classPropertyName: "optionalHelp",
				publicName: "optionalHelp",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			optionalHelpColor: {
				classPropertyName: "optionalHelpColor",
				publicName: "optionalHelpColor",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
			...
			controlClass: {
				classPropertyName: "controlClass",
				publicName: "controlClass",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			},
		...
		queries: [{
			...
			first: true,
			predicate: FormControlName,
			descendants: true,
			isSignal: true
		}],
		viewQueries: [{
			propertyName: "contentElement",
			first: true,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  `,
	...
	propDecorators: {
		...
		formControlName: [{
			type: i0.ContentChild,
			args: [i0.forwardRef(() => FormControlName), { isSignal: true }]
		}],
		contentElement: [{
			type: i0.ViewChild,
			args: ["contentElement", { isSignal: true }]
		}],
		optional: [{
			type: i0.Input,
			args: [{
