...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@delon/util/decorator'), require('rxjs/operators'), require('@delon/util/config'), require('@delon/util/other'), require('@angular/cdk/platform'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/qr', ['exports', '@angular/core', '@delon/util/decorator', 'rxjs/operators', '@delon/util/config', '@delon/util/other', '@angular/cdk/platform', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc.qr = {}), global.ng.core, global.decorator, global.rxjs.operators, global.i1, global.i2, global.ng.cdk.platform, global.ng.common));
}(this, (function (exports, i0, decorator, operators, i1, i2, i3, i4) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ QRModule.ɵinj = i0.ɵɵdefineInjector({ factory: function QRModule_Factory(t) { return new (t || QRModule)(); }, imports: [[i4.CommonModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(QRModule, { declarations: [QRComponent], imports: [i4.CommonModule], exports: [QRComponent] }); })();
    (function () {
