...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('file-saver'), require('@angular/common/http'), require('@delon/util/other'), require('@delon/util/config'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/zip', ['exports', '@angular/core', 'file-saver', '@angular/common/http', '@delon/util/other', '@delon/util/config', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc.zip = {}), global.ng.core, global.saveAs, global.ng.common.http, global.i2, global.i3, global.ng.common));
}(this, (function (exports, i0, fileSaver, i1, i2, i3, common) { 'use strict';
    ...
    /** @nocollapse */ ZipModule.ɵinj = i0.ɵɵdefineInjector({ factory: function ZipModule_Factory(t) { return new (t || ZipModule)(); }, imports: [[common.CommonModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(ZipModule, { imports: [common.CommonModule] }); })();
    (function () {
