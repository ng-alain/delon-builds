    ...
    var STComponent = /** @class */ (function () {
        ...
        STComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [table.NzTableStyleService, STDataSource, STRowSource, STColumnSource, STExport, theme.CNCurrencyPipe, theme.DatePipe, theme.YNPipe, common.DecimalPipe],
                        host: {
                            '[class.st]': "true",
