...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var STComponent = /** @class */ (function () {
         ...
         * @return {?}
         */
        STComponent.prototype._click = function (e, item, column, index) {
            e.preventDefault();
            e.stopPropagation();
            /** @type {?} */
            var res = column.click ? ( /** @type {?} */(column.click))(item, this) : ( /** @type {?} */(column.event))({ record: item, instance: this, event: e, column: column, index: index });
        ...
        STComponent.prototype._btnClick = function (record, btn, e) {
             ...
             * @param {?} res
             * @return {?}
             */function (res) { return _this.btnCallback(record, btn, e, res); }));
                return;
            }
             ...
             * @param {?} res
             * @return {?}
             */ res) { return _this.btnCallback(record, btn, e, res); }));
                return;
            }
            else if (btn.type === 'link') {
                /** @type {?} */
                var clickRes = this.btnCallback(record, btn, e);
         ...
         * @return {?}
         */
        STComponent.prototype.btnCallback = function (record, btn, event, modal) {
            /** @type {?} */
            var fn = btn.click || btn.event;
            if (!fn)
                return;
            if (typeof fn === 'string') {
                switch (fn) {
                ...
                if (btn.click) {
                    ...
                    return (( /** @type {?} */(btn.event)))({ record: record, modal: modal, instance: this, event: event, btn: btn });
                }
            }
        };
        /**
