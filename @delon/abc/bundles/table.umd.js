...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@delon/theme'), require('@delon/util'), require('@angular/platform-browser'), require('@delon/acl'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('@angular/common'), require('@delon/abc/xlsx'), require('@angular/router'), require('@angular/forms'), require('ng-zorro-antd/badge'), require('ng-zorro-antd/checkbox'), require('ng-zorro-antd/divider'), require('ng-zorro-antd/dropdown'), require('ng-zorro-antd/icon'), require('ng-zorro-antd/input'), require('ng-zorro-antd/menu'), require('ng-zorro-antd/popconfirm'), require('ng-zorro-antd/radio'), require('ng-zorro-antd/resizable'), require('ng-zorro-antd/table'), require('ng-zorro-antd/tag'), require('ng-zorro-antd/tooltip')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/st', ['exports', '@angular/core', '@delon/theme', '@delon/util', '@angular/platform-browser', '@delon/acl', '@angular/common/http', 'rxjs', 'rxjs/operators', '@angular/common', '@delon/abc/xlsx', '@angular/router', '@angular/forms', 'ng-zorro-antd/badge', 'ng-zorro-antd/checkbox', 'ng-zorro-antd/divider', 'ng-zorro-antd/dropdown', 'ng-zorro-antd/icon', 'ng-zorro-antd/input', 'ng-zorro-antd/menu', 'ng-zorro-antd/popconfirm', 'ng-zorro-antd/radio', 'ng-zorro-antd/resizable', 'ng-zorro-antd/table', 'ng-zorro-antd/tag', 'ng-zorro-antd/tooltip'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc.st = {}), global.ng.core, global.delon.theme, global.delon.util, global.ng.platformBrowser, global.delon.acl, global.ng.common.http, global.rxjs, global.rxjs.operators, global.ng.common, global.delon.abc.xlsx, global.ng.router, global.ng.forms, global['ng-zorro-antd/badge'], global['ng-zorro-antd/checkbox'], global['ng-zorro-antd/divider'], global['ng-zorro-antd/dropdown'], global['ng-zorro-antd/icon'], global['ng-zorro-antd/input'], global['ng-zorro-antd/menu'], global['ng-zorro-antd/popconfirm'], global['ng-zorro-antd/radio'], global.i8, global['ng-zorro-antd/table'], global['ng-zorro-antd/tag'], global['ng-zorro-antd/tooltip']));
}(this, (function (exports, i0, i1$1, i6, i1, i3, http, rxjs, operators, i1$2, i1$3, i1$4, i6$1, i14, i5, i15, i9, i4, i11, i10, i3$1, i12, i8, i7, i13, i2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var STColumnSource = /** @class */ (function () {
        ...
        STColumnSource.prototype.widgetCoerce = function (item) {
            ...
            if (item.widget == null || !this.stWidgetRegistry.has(item.widget.type)) {
                delete item.type;
                i6.warn("st: No widget for type \"" + ((_a = item.widget) === null || _a === void 0 ? void 0 : _a.type) + "\"");
            }
        };
    ...
    var STDataSource = /** @class */ (function () {
        ...
        STDataSource.prototype.process = function (options) {
            ...
            if (typeof data === 'string') {
                ...
                data$ = this.getByHttp(data, options).pipe(operators.map(function (result) {
                    ...
                    if (Array.isArray(result)) {
                        ...
                        // list
                        ret = i6.deepGet(result, res.reName.list, []);
                        if (ret == null || !Array.isArray(ret)) {
                            ret = [];
                        }
                        // total
                        var resultTotal = res.reName.total && i6.deepGet(result, res.reName.total, null);
                        retTotal = resultTotal == null ? total || 0 : +resultTotal;
                    }
                    return i6.deepCopy(ret);
                }));
            }
            ...
            if (!isRemote) {
                ...
                operators.map(function (result) {
                    rawData = result;
                    var copyResult = i6.deepCopy(result);
        ...
        STDataSource.prototype.get = function (item, col, idx) {
            try {
                ...
                var value = i6.deepGet(item, col.index, col.default);
                var text = value;
                var color = void 0;
                switch (col.type) {
                    case 'no':
        ...
        STDataSource.prototype.getByHttp = function (url, options) {
            ...
            if (paginator) {
                if (req.type === 'page') {
                    params = (_a = {},
                        _a[reName.pi] = page.zeroIndexed ? pi - 1 : pi,
                        _a[reName.ps] = ps,
                        _a);
                }
                else {
                    params = (_b = {},
                        _b[reName.skip] = (pi - 1) * ps,
                        _b[reName.limit] = ps,
                        _b);
                }
            }
        ...
        STDataSource.prototype.getReqSortMap = function (singleSort, multiSort, columns) {
            ...
            if (multiSort) {
                ...
                ret = (_a = {}, _a[ms_1.key] = ms_1.arrayParam ? sortMap : sortMap.join(ms_1.separator), _a);
    ...
    /** @nocollapse */ STDataSource.ɵfac = function STDataSource_Factory(t) { return new (t || STDataSource)(i0.ɵɵinject(i1$1._HttpClient), i0.ɵɵinject(i1$1.CNCurrencyPipe, 1), i0.ɵɵinject(i1$1.DatePipe, 1), i0.ɵɵinject(i1$1.YNPipe, 1), i0.ɵɵinject(i1$2.DecimalPipe, 1), i0.ɵɵinject(i1.DomSanitizer)); };
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(STDataSource, [{
            ...
            return [{ type: i1$1._HttpClient }, { type: i1$1.CNCurrencyPipe, decorators: [{
                            type: i0.Host
                        }] }, { type: i1$1.DatePipe, decorators: [{
                            type: i0.Host
    ...
    var STExport = /** @class */ (function () {
        ...
        STExport.prototype._stGet = function (item, col, index) {
            ...
            if (col.format) {
                ...
                var val = i6.deepGet(item, col.index, '');
                ret.v = val;
                if (val != null) {
                    switch (col.type) {
                        case 'currency':
    ...
    var STComponent = /** @class */ (function () {
        ...
        Object.defineProperty(STComponent.prototype, "req", {
            ...
            set: function (value) {
                this._req = i6.deepMergeKey({}, true, this.cog.req, value);
            },
            enumerable: false,
            configurable: true
        });
        Object.defineProperty(STComponent.prototype, "res", {
            ...
            set: function (value) {
                var item = (this._res = i6.deepMergeKey({}, true, this.cog.res, value));
        ...
        Object.defineProperty(STComponent.prototype, "multiSort", {
            ...
            set: function (value) {
                if ((typeof value === 'boolean' && !i6.toBoolean(value)) || (typeof value === 'object' && Object.keys(value).length === 0)) {
        ...
        Object.defineProperty(STComponent.prototype, "resizable", {
            set: function (val) {
                this._resizable = typeof val === 'object' ? val : { disabled: !i6.toBoolean(val) };
            },
            enumerable: false,
            configurable: true
        });
        ...
        STComponent.prototype.setRow = function (index, item, options) {
            ...
            this._data[index] = i6.deepMergeKey(this._data[index], false, item);
            this.optimizeData();
        ...
        STComponent.prototype._btnClick = function (record, btn, e) {
            ...
            if (btn.type === 'modal' || btn.type === 'static') {
                ...
                this.modalHelper[btn.type === 'modal' ? 'create' : 'createStatic'](modal.component, Object.assign(Object.assign({}, obj), (modal.params && modal.params(record))), i6.deepMergeKey({}, true, this.cog.modal, modal))
                ...
                this.drawerHelper
                    .create(drawer.title, drawer.component, Object.assign(Object.assign({}, obj), (drawer.params && drawer.params(record))), i6.deepMergeKey({}, true, this.cog.drawer, drawer))
                    .pipe(operators.filter(function (w) { return typeof w !== 'undefined'; }))
                    .subscribe(function (res) { return _this.btnCallback(record, btn, res); });
                return;
            }
        ...
        STComponent.prototype.pureItem = function (itemOrIndex) {
            ...
            var copyItem = i6.deepCopy(itemOrIndex);
