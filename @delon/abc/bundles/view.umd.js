...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@delon/util/decorator'), require('@delon/util/config'), require('@angular/common'), require('ng-zorro-antd/tooltip'), require('@delon/util/browser'), require('@delon/theme'), require('ng-zorro-antd/core/outlet'), require('ng-zorro-antd/icon'), require('@angular/cdk/observers')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/sv', ['exports', '@angular/core', '@delon/util/decorator', '@delon/util/config', '@angular/common', 'ng-zorro-antd/tooltip', '@delon/util/browser', '@delon/theme', 'ng-zorro-antd/core/outlet', 'ng-zorro-antd/icon', '@angular/cdk/observers'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc.sv = {}), global.ng.core, global.decorator, global.i1, global.ng.common, global['ng-zorro-antd/tooltip'], global.browser, global.i2$1, global['ng-zorro-antd/core/outlet'], global['ng-zorro-antd/icon'], global.ng.cdk.observers));
}(this, (function (exports, i0, decorator, i1, i1$1, i2, browser, i2$1, i3, i6, i7) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ SVModule.ɵinj = i0.ɵɵdefineInjector({ factory: function SVModule_Factory(t) { return new (t || SVModule)(); }, imports: [[i1$1.CommonModule, i7.ObserversModule, i2.NzToolTipModule, i6.NzIconModule, i3.NzOutletModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(SVModule, { declarations: [SVContainerComponent, SVComponent, SVTitleComponent, SVValueComponent], imports: [i1$1.CommonModule, i7.ObserversModule, i2.NzToolTipModule, i6.NzIconModule, i3.NzOutletModule], exports: [SVContainerComponent, SVComponent, SVTitleComponent, SVValueComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(SVModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [i1$1.CommonModule, i7.ObserversModule, i2.NzToolTipModule, i6.NzIconModule, i3.NzOutletModule],
