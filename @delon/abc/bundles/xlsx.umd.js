...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('file-saver'), require('isutf8'), require('@angular/common/http'), require('@delon/util/other'), require('@delon/util/config'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/xlsx', ['exports', '@angular/core', 'file-saver', 'isutf8', '@angular/common/http', '@delon/util/other', '@delon/util/config', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc.xlsx = {}), global.ng.core, global.saveAs, global.isUtf8, global.ng.common.http, global.i2, global.i3, global.ng.common));
}(this, (function (exports, i0, fileSaver, isUtf8, i1, i2, i3, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ XlsxDirective.ɵfac = function XlsxDirective_Factory(t) { return new (t || XlsxDirective)(i0.ɵɵdirectiveInject(XlsxService)); };
    /** @nocollapse */ XlsxDirective.ɵdir = i0.ɵɵngDeclareDirective({ version: "11.1.1", type: XlsxDirective, selector: "[xlsx]", inputs: { data: ["xlsx", "data"] }, host: { listeners: { "click": "_click()" } }, exportAs: ["xlsx"], ngImport: i0__namespace });
    (function () {
    ...
    /** @nocollapse */ XlsxModule.ɵmod = i0.ɵɵdefineNgModule({ type: XlsxModule });
    /** @nocollapse */ XlsxModule.ɵinj = i0.ɵɵdefineInjector({ factory: function XlsxModule_Factory(t) { return new (t || XlsxModule)(); }, imports: [[common.CommonModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(XlsxModule, { declarations: [XlsxDirective], imports: [common.CommonModule], exports: [XlsxDirective] }); })();
    (function () {
