...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@delon/util/decorator'), require('rxjs'), require('rxjs/operators'), require('@delon/util/config'), require('@angular/cdk/bidi'), require('ng-zorro-antd/icon')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/error-collect', ['exports', '@angular/common', '@angular/core', '@delon/util/decorator', 'rxjs', 'rxjs/operators', '@delon/util/config', '@angular/cdk/bidi', 'ng-zorro-antd/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc['error-collect'] = {}), global.ng.common, global.ng.core, global.decorator, global.rxjs, global.rxjs.operators, global.i1, global.ng.cdk.bidi, global['ng-zorro-antd/icon']));
}(this, (function (exports, common, i0, decorator, rxjs, operators, i1, i2, i3) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ ErrorCollectModule.ɵinj = i0.ɵɵdefineInjector({ factory: function ErrorCollectModule_Factory(t) { return new (t || ErrorCollectModule)(); }, imports: [[common.CommonModule, i3.NzIconModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(ErrorCollectModule, { declarations: [ErrorCollectComponent], imports: [common.CommonModule, i3.NzIconModule], exports: [ErrorCollectComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ErrorCollectModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [common.CommonModule, i3.NzIconModule],
