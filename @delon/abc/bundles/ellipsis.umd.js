...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@delon/util/decorator'), require('rxjs/operators'), require('@angular/platform-browser'), require('@angular/cdk/observers'), require('ng-zorro-antd/tooltip')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/ellipsis', ['exports', '@angular/common', '@angular/core', '@delon/util/decorator', 'rxjs/operators', '@angular/platform-browser', '@angular/cdk/observers', 'ng-zorro-antd/tooltip'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc.ellipsis = {}), global.ng.common, global.ng.core, global.decorator, global.rxjs.operators, global.ng.platformBrowser, global.ng.cdk.observers, global['ng-zorro-antd/tooltip']));
}(this, (function (exports, i3, i0, decorator, operators, i1, i2, i4) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ EllipsisModule.ɵinj = i0.ɵɵdefineInjector({ factory: function EllipsisModule_Factory(t) { return new (t || EllipsisModule)(); }, imports: [[i3.CommonModule, i2.ObserversModule, i4.NzToolTipModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(EllipsisModule, { declarations: [EllipsisComponent], imports: [i3.CommonModule, i2.ObserversModule, i4.NzToolTipModule], exports: [EllipsisComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(EllipsisModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [i3.CommonModule, i2.ObserversModule, i4.NzToolTipModule],
