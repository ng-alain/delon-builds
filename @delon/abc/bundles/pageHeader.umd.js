...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('@delon/abc/reuse-tab'), require('@delon/theme'), require('@delon/util/browser'), require('@delon/util/decorator'), require('rxjs'), require('rxjs/operators'), require('@delon/util/config'), require('@angular/cdk/platform'), require('@angular/cdk/bidi'), require('@angular/common'), require('ng-zorro-antd/affix'), require('ng-zorro-antd/skeleton'), require('ng-zorro-antd/breadcrumb'), require('@angular/cdk/observers')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/page-header', ['exports', '@angular/core', '@angular/router', '@delon/abc/reuse-tab', '@delon/theme', '@delon/util/browser', '@delon/util/decorator', 'rxjs', 'rxjs/operators', '@delon/util/config', '@angular/cdk/platform', '@angular/cdk/bidi', '@angular/common', 'ng-zorro-antd/affix', 'ng-zorro-antd/skeleton', 'ng-zorro-antd/breadcrumb', '@angular/cdk/observers'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc['page-header'] = {}), global.ng.core, global.ng.router, global.delon.abc['reuse-tab'], global.delon.theme, global.browser, global.decorator, global.rxjs, global.rxjs.operators, global.i3, global.ng.cdk.platform, global.ng.cdk.bidi, global.ng.common, global['ng-zorro-antd/affix'], global['ng-zorro-antd/skeleton'], global['ng-zorro-antd/breadcrumb'], global.ng.cdk.observers));
}(this, (function (exports, i0, i2, i6, i1, browser, decorator, rxjs, operators, i3, i4, i5, i7, i8, i9, i10, i11) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ PageHeaderModule.ɵinj = i0.ɵɵdefineInjector({ factory: function PageHeaderModule_Factory(t) { return new (t || PageHeaderModule)(); }, imports: [[i7.CommonModule, i2.RouterModule, i11.ObserversModule, i8.NzAffixModule, i9.NzSkeletonModule, i10.NzBreadCrumbModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(PageHeaderModule, { declarations: [PageHeaderComponent], imports: [i7.CommonModule, i2.RouterModule, i11.ObserversModule, i8.NzAffixModule, i9.NzSkeletonModule, i10.NzBreadCrumbModule], exports: [PageHeaderComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(PageHeaderModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [i7.CommonModule, i2.RouterModule, i11.ObserversModule, i8.NzAffixModule, i9.NzSkeletonModule, i10.NzBreadCrumbModule],
