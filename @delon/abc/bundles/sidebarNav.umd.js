...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@delon/abc/sidebar-nav', ['exports', '@angular/common', '@angular/core', '@angular/router', '@delon/theme', '@delon/util/decorator', 'rxjs', 'rxjs/operators', '@angular/platform-browser', '@angular/cdk/bidi', 'ng-zorro-antd/icon', 'ng-zorro-antd/tooltip'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc['sidebar-nav'] = {}), global.ng.common, global.ng.core, global.ng.router, global.delon.theme, global.decorator, global.rxjs, global.rxjs.operators, global.ng.platformBrowser, global.ng.cdk.bidi, global['ng-zorro-antd/icon'], global['ng-zorro-antd/tooltip']));
}(this, (function (exports, i5, i0, i2, i1, decorator, rxjs, operators, i3, i4, i6, i7) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ SidebarNavModule.ɵinj = i0.ɵɵdefineInjector({ factory: function SidebarNavModule_Factory(t) { return new (t || SidebarNavModule)(); }, imports: [[i5.CommonModule, i2.RouterModule, i6.NzIconModule, i7.NzToolTipModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(SidebarNavModule, { declarations: [SidebarNavComponent], imports: [i5.CommonModule, i2.RouterModule, i6.NzIconModule, i7.NzToolTipModule], exports: [SidebarNavComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(SidebarNavModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [i5.CommonModule, i2.RouterModule, i6.NzIconModule, i7.NzToolTipModule],
