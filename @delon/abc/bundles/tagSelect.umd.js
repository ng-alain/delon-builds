...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@delon/util/decorator'), require('rxjs'), require('rxjs/operators'), require('@delon/theme'), require('@angular/cdk/bidi'), require('@angular/common'), require('ng-zorro-antd/icon')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/tag-select', ['exports', '@angular/core', '@delon/util/decorator', 'rxjs', 'rxjs/operators', '@delon/theme', '@angular/cdk/bidi', '@angular/common', 'ng-zorro-antd/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc['tag-select'] = {}), global.ng.core, global.decorator, global.rxjs, global.rxjs.operators, global.delon.theme, global.ng.cdk.bidi, global.ng.common, global['ng-zorro-antd/icon']));
}(this, (function (exports, i0, decorator, rxjs, operators, i1, i2, i3, i4) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ TagSelectModule.ɵinj = i0.ɵɵdefineInjector({ factory: function TagSelectModule_Factory(t) { return new (t || TagSelectModule)(); }, imports: [[i3.CommonModule, i4.NzIconModule, i1.DelonLocaleModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(TagSelectModule, { declarations: [TagSelectComponent], imports: [i3.CommonModule, i4.NzIconModule, i1.DelonLocaleModule], exports: [TagSelectComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(TagSelectModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [i3.CommonModule, i4.NzIconModule, i1.DelonLocaleModule],
