...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/bidi'), require('@angular/core'), require('@angular/platform-browser'), require('@delon/theme'), require('@delon/util/browser'), require('@ngneat/until-destroy'), require('@angular/common'), require('@angular/router'), require('ng-zorro-antd/button')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/exception', ['exports', '@angular/cdk/bidi', '@angular/core', '@angular/platform-browser', '@delon/theme', '@delon/util/browser', '@ngneat/until-destroy', '@angular/common', '@angular/router', 'ng-zorro-antd/button'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc.exception = {}), global.ng.cdk.bidi, global.ng.core, global.ng.platformBrowser, global.delon.theme, global.browser, global.untilDestroy, global.ng.common, global.ng.router, global['ng-zorro-antd/button']));
}(this, (function (exports, bidi, core, platformBrowser, theme, browser, untilDestroy, common, router, button) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.ExceptionComponent = /** @class */ (function () {
        ...
        ExceptionComponent.prototype.ngOnInit = function () {
            ...
            this.i18n.change.pipe(untilDestroy.untilDestroyed(this)).subscribe(function () { return (_this.locale = _this.i18n.getData('exception')); });
            this.checkContent();
        };
        return ExceptionComponent;
    }());
    exports.ExceptionComponent.decorators = [
    ...
    /** @nocollapse */
    exports.ExceptionComponent.ctorParameters = function () { return [
        { type: theme.DelonLocaleService },
        { type: platformBrowser.DomSanitizer },
        { type: bidi.Directionality, decorators: [{ type: core.Optional }] }
    ]; };
    exports.ExceptionComponent.propDecorators = {
    ...
    exports.ExceptionComponent = __decorate([
        untilDestroy.UntilDestroy(),
        __metadata("design:paramtypes", [theme.DelonLocaleService, platformBrowser.DomSanitizer, bidi.Directionality])
    ], exports.ExceptionComponent);

    var COMPONENTS = [exports.ExceptionComponent];
