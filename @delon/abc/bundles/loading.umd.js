...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('ng-zorro-antd/spin'), require('ng-zorro-antd/icon'), require('@angular/cdk/portal'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/overlay'), require('@delon/util'), require('@angular/cdk/bidi')) :
    typeof define === 'function' && define.amd ? define('@delon/abc/loading', ['exports', '@angular/core', '@angular/common', 'ng-zorro-antd/spin', 'ng-zorro-antd/icon', '@angular/cdk/portal', 'rxjs', 'rxjs/operators', '@angular/cdk/overlay', '@delon/util', '@angular/cdk/bidi'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.abc = global.delon.abc || {}, global.delon.abc.loading = {}), global.ng.core, global.ng.common, global['ng-zorro-antd/spin'], global['ng-zorro-antd/icon'], global.ng.cdk.portal, global.rxjs, global.rxjs.operators, global.ng.cdk.overlay, global.delon.util, global.ng.cdk.bidi));
