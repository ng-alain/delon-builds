...
export declare class ReuseTabContextMenuComponent implements OnInit {
    ...
    static ɵfac: i0.ɵɵFactoryDef<ReuseTabContextMenuComponent, never>;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<ReuseTabContextMenuComponent, "reuse-tab-context-menu", never, { "i18n": "i18n"; "item": "item"; "event": "event"; "customContextMenu": "customContextMenu"; }, { "close": "close"; }, never, never>;
}
