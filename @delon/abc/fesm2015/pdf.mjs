...
class PdfComponent {
    ...
    initDelay() {
        ...
        timer((_a = this.delay) !== null && _a !== void 0 ? _a : 0)
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: PdfComponent, decorators: [{
  ...
  `,
        ...
        return [{ type: i0.NgZone }, { type: i1.AlainConfigService }, { type: i2.LazyService }, { type: i3.Platform }, { type: i0.ElementRef }, { type: undefined, decorators: [{
                        type: Optional
                    }, {
                        type: Inject,
                        args: [DOCUMENT]
