...
/** @nocollapse */ MediaModule.ɵinj = ɵɵdefineInjector({ factory: function MediaModule_Factory(t) { return new (t || MediaModule)(); }, imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(MediaModule, { declarations: [MediaComponent], imports: [CommonModule], exports: [MediaComponent] }); })();
