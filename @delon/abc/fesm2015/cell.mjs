...
class CellService {
    ...
    get(value, options) {
        const type = this.genType(value, Object.assign({}, options));
        ...
        if ((widget === null || widget === void 0 ? void 0 : widget.type) === 'fn') {
...
CellHostDirective.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: CellHostDirective, deps: [{ token: CellService }, { token: i0.ViewContainerRef }], target: i0.ɵɵFactoryTarget.Directive });
CellHostDirective.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "14.2.10", type: CellHostDirective, selector: "[cell-widget-host]", inputs: { data: "data" }, ngImport: i0 });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: CellHostDirective, decorators: [{
            type: Directive,
...
class CellComponent {
    ...
    get safeOpt() {
        var _a;
        return (_a = this.res) === null || _a === void 0 ? void 0 : _a.options;
    }
    get isText() {
        var _a;
        return ((_a = this.res) === null || _a === void 0 ? void 0 : _a.safeHtml) === 'text';
    }
    get hostData() {
        return {
            value: this.value,
    ...
    updateValue() {
        ...
        this.destroy$ = this.srv.get(this.value, this.options).subscribe(res => {
            ...
            this._text = (_b = (_a = res.result) === null || _a === void 0 ? void 0 : _a.text) !== null && _b !== void 0 ? _b : '';
            this._unit = (_d = (_c = res.result) === null || _c === void 0 ? void 0 : _c.unit) !== null && _d !== void 0 ? _d : this.unit;
    ...
    _link(e) {
        ...
        if (url.startsWith('/')) {
            ...
            this.win.open(url, link === null || link === void 0 ? void 0 : link.target);
        }
    }
    _showImg(img) {
...
CellComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: CellComponent, deps: [{ token: CellService }, { token: i2$1.Router }, { token: i0.ChangeDetectorRef }, { token: i0.ElementRef }, { token: i0.Renderer2 }, { token: i3$1.NzImageService }, { token: WINDOW }], target: i0.ɵɵFactoryTarget.Component });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: CellComponent, decorators: [{
  ...
  `,
        ...
        return [{ type: CellService }, { type: i2$1.Router }, { type: i0.ChangeDetectorRef }, { type: i0.ElementRef }, { type: i0.Renderer2 }, { type: i3$1.NzImageService }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [WINDOW]
                    }] }];
...
CellModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: CellModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
CellModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "14.2.10", ngImport: i0, type: CellModule, declarations: [CellComponent, CellHostDirective], imports: [CommonModule, NzBadgeModule, NzTagModule, NzToolTipModule, NzIconModule, NzImageModule], exports: [CellComponent] });
CellModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: CellModule, imports: [CommonModule, NzBadgeModule, NzTagModule, NzToolTipModule, NzIconModule, NzImageModule] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "14.2.10", ngImport: i0, type: CellModule, decorators: [{
            type: NgModule,
            args: [{
