...
/** @nocollapse */ LodopService.ɵfac = function LodopService_Factory(t) { return new (t || LodopService)(ɵɵinject(LazyService), ɵɵinject(AlainConfigService)); };
/** @nocollapse */ LodopService.ɵprov = ɵɵdefineInjectable({ token: LodopService, factory: LodopService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(LodopService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: LazyService }, { type: AlainConfigService }]; }, null); })();

class LodopModule {
}
/** @nocollapse */ LodopModule.ɵmod = ɵɵdefineNgModule({ type: LodopModule });
/** @nocollapse */ LodopModule.ɵinj = ɵɵdefineInjector({ factory: function LodopModule_Factory(t) { return new (t || LodopModule)(); }, imports: [[DelonUtilModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(LodopModule, { imports: [DelonUtilModule] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(LodopModule, [{
        type: NgModule,
        args: [{
