...
import { EventEmitter, ɵɵdirectiveInject, NgZone, ElementRef, ɵɵngDeclareComponent, ChangeDetectionStrategy, ViewEncapsulation, ɵsetClassMetadata, Component, Optional, Inject, Input, Output, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
...
/** @nocollapse */ PdfComponent.ɵfac = function PdfComponent_Factory(t) { return new (t || PdfComponent)(ɵɵdirectiveInject(NgZone), ɵɵdirectiveInject(AlainConfigService), ɵɵdirectiveInject(LazyService), ɵɵdirectiveInject(Platform), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT, 8)); };
/** @nocollapse */ PdfComponent.ɵcmp = ɵɵngDeclareComponent({ version: "11.1.1", type: PdfComponent, selector: "pdf", inputs: { src: "src", pi: "pi", showAll: "showAll", renderText: "renderText", textLayerMode: "textLayerMode", showBorders: "showBorders", stickToPage: "stickToPage", originalSize: "originalSize", fitToPage: "fitToPage", zoom: "zoom", zoomScale: "zoomScale", rotation: "rotation", autoReSize: "autoReSize", externalLinkTarget: "externalLinkTarget", delay: "delay" }, outputs: { change: "change" }, host: { properties: { "class.pdf-container": "true" } }, exportAs: ["pdf"], usesOnChanges: true, ngImport: i0, template: `
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(PdfComponent, [{
        type: Component,
        args: [{
                selector: 'pdf',
                exportAs: 'pdf',
  ...
  `,
    ...
    }], function () { return [{ type: NgZone }, { type: AlainConfigService }, { type: LazyService }, { type: Platform }, { type: ElementRef }, { type: Document, decorators: [{
                type: Optional
            }, {
                type: Inject,
                args: [DOCUMENT]
...
/** @nocollapse */ PdfModule.ɵmod = ɵɵdefineNgModule({ type: PdfModule });
/** @nocollapse */ PdfModule.ɵinj = ɵɵdefineInjector({ factory: function PdfModule_Factory(t) { return new (t || PdfModule)(); }, imports: [[CommonModule, DelonUtilModule, NzSkeletonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(PdfModule, { declarations: [PdfComponent], imports: [CommonModule, DelonUtilModule, NzSkeletonModule], exports: [PdfComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(PdfModule, [{
        type: NgModule,
        args: [{
