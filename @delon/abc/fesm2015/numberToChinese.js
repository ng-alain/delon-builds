...
/** @nocollapse */ NaNumberToChinesePipe.ɵpipe = ɵɵdefinePipe({ name: "n2c", type: NaNumberToChinesePipe, pure: true });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(NaNumberToChinesePipe, [{
        type: Pipe,
        args: [{ name: 'n2c' }]
    }], null, null); })();
...
/** @nocollapse */ NumberToChineseModule.ɵmod = ɵɵdefineNgModule({ type: NumberToChineseModule });
/** @nocollapse */ NumberToChineseModule.ɵinj = ɵɵdefineInjector({ factory: function NumberToChineseModule_Factory(t) { return new (t || NumberToChineseModule)(); }, imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(NumberToChineseModule, { declarations: [NaNumberToChinesePipe], imports: [CommonModule], exports: [NaNumberToChinesePipe] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(NumberToChineseModule, [{
        type: NgModule,
        args: [{
