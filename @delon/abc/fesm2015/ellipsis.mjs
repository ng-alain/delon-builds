...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.3.11", ngImport: i0, type: EllipsisComponent, decorators: [{
            type: Component,
        ...
        return [{ type: i0.ElementRef }, { type: i0.NgZone }, { type: i1.DomSanitizer }, { type: undefined, decorators: [{
                        type: Inject,
                        args: [DOCUMENT]
