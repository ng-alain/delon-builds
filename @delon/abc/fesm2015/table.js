...
class STColumnSource {
     ...
     * @return {?}
     */
    fixResizable(resizable) {
        return typeof resizable === 'boolean' ? ((/** @type {?} */ ({ disabled: !resizable }))) : resizable;
    }
    /**
     * @param {?} list
     * @param {?} widthMode
    ...
    process(list, widthMode, resizable) {
        ...
        (item) => {
            ...
            // resizable
            item.resizable = Object.assign(Object.assign({ disabled: true, bounds: 'window', minWidth: 60, maxWidth: 360, preview: true }, validRootResizable), this.fixResizable((/** @type {?} */ (item.resizable))));
            item.__point = point++;
            return item;
        });
        /** @type {?} */
...
class STComponent {
    ...
    refreshColumns() {
        /** @type {?} */
        const res = (/** @type {?} */ (this)).columnSource.process((/** @type {?} */ ((/** @type {?} */ (this)).columns)), (/** @type {?} */ (this)).widthMode, (/** @type {?} */ (this)).resizable);
...
if (false) {
    ...
    /** @type {?} */
    STComponent.prototype.resizable;
    /** @type {?} */
