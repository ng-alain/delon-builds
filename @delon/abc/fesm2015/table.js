...
import { ALAIN_I18N_TOKEN, _HttpClient, DatePipe, YNPipe, ModalHelper, DrawerHelper, DelonLocaleService, CNCurrencyPipe } from '@delon/theme';
...
/** @nocollapse */ STDataSource.ɵfac = function STDataSource_Factory(t) { return new (t || STDataSource)(ɵɵinject(_HttpClient), ɵɵinject(DatePipe, 1), ɵɵinject(YNPipe, 1), ɵɵinject(DecimalPipe, 1), ɵɵinject(CurrencyService), ɵɵinject(DomSanitizer)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(STDataSource, [{
        type: Injectable
    }], function () { return [{ type: _HttpClient }, { type: DatePipe, decorators: [{
                type: Host
            }] }, { type: YNPipe, decorators: [{
                type: Host
            }] }, { type: DecimalPipe, decorators: [{
                type: Host
            }] }, { type: CurrencyService }, { type: DomSanitizer }]; }, null); })();
