import { Injectable, Directive, TemplateRef, Host, Input, defineInjectable, Optional, Inject, EventEmitter, Component, ChangeDetectionStrategy, ViewEncapsulation, ChangeDetectorRef, ElementRef, Renderer2, Output, NgModule, NO_ERRORS_SCHEMA } from '@angular/core';
