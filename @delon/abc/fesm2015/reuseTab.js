...
import { EventEmitter, ɵɵdirectiveInject, ɵɵngDeclareComponent, ChangeDetectionStrategy, ViewEncapsulation, ɵsetClassMetadata, Component, Input, Output, ElementRef, ɵɵinject, ɵɵdefineInjectable, Injectable, ɵɵngDeclareDirective, Directive, Injector, ChangeDetectorRef, Optional, Inject, ViewChild, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
import { DelonLocaleService, ScrollService, MenuService, ALAIN_I18N_TOKEN, DelonLocaleModule } from '@delon/theme';
import { NzMenuDirective, NzMenuItemDirective, NzMenuDividerDirective, NzMenuModule } from 'ng-zorro-antd/menu';
import { NgIf, NgForOf, DOCUMENT, CommonModule } from '@angular/common';
...
/** @nocollapse */ ReuseTabContextMenuComponent.ɵfac = function ReuseTabContextMenuComponent_Factory(t) { return new (t || ReuseTabContextMenuComponent)(ɵɵdirectiveInject(DelonLocaleService)); };
/** @nocollapse */ ReuseTabContextMenuComponent.ɵcmp = ɵɵngDeclareComponent({ version: "11.1.1", type: ReuseTabContextMenuComponent, selector: "reuse-tab-context-menu", inputs: { i18n: "i18n", item: "item", event: "event", customContextMenu: "customContextMenu" }, outputs: { close: "close" }, host: { listeners: { "document:click": "closeMenu($event)", "document:contextmenu": "closeMenu($event)" } }, ngImport: i0, template: "<ul nz-menu>\n  <li nz-menu-item (click)=\"click($event, 'refresh')\" data-type=\"refresh\" [innerHTML]=\"i18n.refresh\"></li>\n  <li nz-menu-item (click)=\"click($event, 'close')\" data-type=\"close\" [nzDisabled]=\"!item.closable\" [innerHTML]=\"i18n.close\"></li>\n  <li nz-menu-item (click)=\"click($event, 'closeOther')\" data-type=\"closeOther\" [innerHTML]=\"i18n.closeOther\"></li>\n  <li nz-menu-item (click)=\"click($event, 'closeRight')\" data-type=\"closeRight\" [nzDisabled]=\"item.last\" [innerHTML]=\"i18n.closeRight\"></li>\n  <ng-container *ngIf=\"customContextMenu!.length > 0\">\n    <li nz-menu-divider></li>\n    <li\n      *ngFor=\"let i of customContextMenu\"\n      nz-menu-item\n      [attr.data-type]=\"i.id\"\n      [nzDisabled]=\"isDisabled(i)\"\n      (click)=\"click($event, 'custom', i)\"\n      [innerHTML]=\"i.title\"\n    ></li>\n  </ng-container>\n</ul>\n", directives: [{ type: NzMenuDirective, selector: "[nz-menu]", inputs: ["nzInlineIndent", "nzTheme", "nzMode", "nzInlineCollapsed", "nzSelectable"], outputs: ["nzClick"], exportAs: ["nzMenu"] }, { type: NzMenuItemDirective, selector: "[nz-menu-item]", inputs: ["nzDisabled", "nzSelected", "nzDanger", "nzMatchRouterExact", "nzMatchRouter", "nzPaddingLeft"], exportAs: ["nzMenuItem"] }, { type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: NzMenuDividerDirective, selector: "[nz-menu-divider]", exportAs: ["nzMenuDivider"] }, { type: NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }], changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ReuseTabContextMenuComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: DelonLocaleService }]; }, { i18n: [{
            type: Input
        }], item: [{
            type: Input
        }], event: [{
...
/** @nocollapse */ ReuseTabContextService.ɵfac = function ReuseTabContextService_Factory(t) { return new (t || ReuseTabContextService)(ɵɵinject(Overlay)); };
/** @nocollapse */ ReuseTabContextService.ɵprov = ɵɵdefineInjectable({ token: ReuseTabContextService, factory: ReuseTabContextService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ReuseTabContextService, [{
        type: Injectable
...
/** @nocollapse */ ReuseTabContextComponent.ɵfac = function ReuseTabContextComponent_Factory(t) { return new (t || ReuseTabContextComponent)(ɵɵdirectiveInject(ReuseTabContextService)); };
/** @nocollapse */ ReuseTabContextComponent.ɵcmp = ɵɵngDeclareComponent({ version: "11.1.1", type: ReuseTabContextComponent, selector: "reuse-tab-context", inputs: { i18n: "i18n" }, outputs: { change: "change" }, ngImport: i0, template: ``, isInline: true });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ReuseTabContextComponent, [{
        type: Component,
        args: [{
...
/** @nocollapse */ ReuseTabContextDirective.ɵfac = function ReuseTabContextDirective_Factory(t) { return new (t || ReuseTabContextDirective)(ɵɵdirectiveInject(ReuseTabContextService)); };
/** @nocollapse */ ReuseTabContextDirective.ɵdir = ɵɵngDeclareDirective({ version: "11.1.1", type: ReuseTabContextDirective, selector: "[reuse-tab-context-menu]", inputs: { item: ["reuse-tab-context-menu", "item"], customContextMenu: "customContextMenu" }, host: { listeners: { "contextmenu": "_onContextMenu($event)" } }, exportAs: ["reuseTabContextMenu"], ngImport: i0 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ReuseTabContextDirective, [{
        type: Directive,
        args: [{
                selector: '[reuse-tab-context-menu]',
...
/** @nocollapse */ ReuseTabService.ɵfac = function ReuseTabService_Factory(t) { return new (t || ReuseTabService)(ɵɵinject(Injector), ɵɵinject(MenuService)); };
/** @nocollapse */ ReuseTabService.ɵprov = ɵɵdefineInjectable({ token: ReuseTabService, factory: ReuseTabService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ReuseTabService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: Injector }, { type: MenuService }]; }, null); })();
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(ReuseTabComponent, [{
    ...
    }], function () { return [{ type: ReuseTabService }, { type: ChangeDetectorRef }, { type: Router }, { type: ActivatedRoute }, { type: undefined, decorators: [{
                type: Optional
            }, {
                type: Inject,
...
/** @nocollapse */ ReuseTabModule.ɵmod = ɵɵdefineNgModule({ type: ReuseTabModule });
/** @nocollapse */ ReuseTabModule.ɵinj = ɵɵdefineInjector({ factory: function ReuseTabModule_Factory(t) { return new (t || ReuseTabModule)(); }, imports: [[CommonModule, RouterModule, DelonLocaleModule, NzMenuModule, NzTabsModule, NzIconModule, OverlayModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(ReuseTabModule, { declarations: [ReuseTabComponent, ReuseTabContextMenuComponent, ReuseTabContextComponent, ReuseTabContextDirective], imports: [CommonModule, RouterModule, DelonLocaleModule, NzMenuModule, NzTabsModule, NzIconModule, OverlayModule], exports: [ReuseTabComponent] }); })();
