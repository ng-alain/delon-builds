...
/** @nocollapse */ SEModule.ɵinj = ɵɵdefineInjector({ factory: function SEModule_Factory(t) { return new (t || SEModule)(); }, imports: [[CommonModule, NzToolTipModule, NzIconModule, NzOutletModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(SEModule, { declarations: [SEContainerComponent, SEComponent, SETitleComponent], imports: [CommonModule, NzToolTipModule, NzIconModule, NzOutletModule], exports: [SEContainerComponent, SEComponent, SETitleComponent] }); })();
