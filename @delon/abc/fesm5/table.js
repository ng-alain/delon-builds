...
import { Injectable, Directive, TemplateRef, Host, Input, defineInjectable, Optional, Inject, Component, ChangeDetectionStrategy, ChangeDetectorRef, ElementRef, Renderer2, Output, EventEmitter, NgModule, NO_ERRORS_SCHEMA } from '@angular/core';
...
import { deepCopy, deepGet, deepMerge, deepMergeKey, toBoolean, updateHostClass, InputNumber, InputBoolean, DelonUtilModule } from '@delon/util';
...
var STComponent = /** @class */ (function () {
    ...
    function (e, record, btn) {
        ...
        if (btn.type === 'modal' || btn.type === 'static') {
            ...
            ((/** @type {?} */ (this.modalHelper[btn.type === 'modal' ? 'create' : 'createStatic'])))((/** @type {?} */ (modal)).component, __assign({}, obj, ((/** @type {?} */ (modal)).params != null ? (/** @type {?} */ ((/** @type {?} */ (modal)).params))(record) : {})), deepMergeKey({}, true, this.copyCog.modal, modal))
                .pipe(filter((/**
             * @param {?} w
             * @return {?}
             */
            ...
            this.drawerHelper
                .create((/** @type {?} */ ((/** @type {?} */ (drawer)).title)), (/** @type {?} */ (drawer)).component, __assign({}, obj, ((/** @type {?} */ (drawer)).params != null ? (/** @type {?} */ ((/** @type {?} */ (drawer)).params))(record) : {})), deepMergeKey({}, true, this.copyCog.drawer, drawer))
                .pipe(filter((/**
             * @param {?} w
             * @return {?}
             */
