...
export declare class MediaComponent implements OnChanges, AfterViewInit, OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDef<MediaComponent, never>;
    static ɵcmp: i0.ɵɵComponentDefWithMeta<MediaComponent, "media", ["mediaComponent"], { "type": "type"; "source": "source"; "options": "options"; "delay": "delay"; }, { "ready": "ready"; }, never, ["*"]>;
}
