...
import { InjectionToken, inject, ɵɵinject, ɵɵdefineInjectable, ɵsetClassMetadata, Injectable, Inject, ɵɵdefineNgModule, ɵɵdefineInjector, NgModule } from '@angular/core';
...
/** @nocollapse */ CacheService.ɵfac = function CacheService_Factory(t) { return new (t || CacheService)(ɵɵinject(AlainConfigService), ɵɵinject(DC_STORE_STORAGE_TOKEN), ɵɵinject(HttpClient)); };
/** @nocollapse */ CacheService.ɵprov = ɵɵdefineInjectable({ token: CacheService, factory: CacheService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(CacheService, [{
        type: Injectable,
...
/** @nocollapse */ DelonCacheModule.ɵmod = ɵɵdefineNgModule({ type: DelonCacheModule });
/** @nocollapse */ DelonCacheModule.ɵinj = ɵɵdefineInjector({ factory: function DelonCacheModule_Factory(t) { return new (t || DelonCacheModule)(); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(DelonCacheModule, [{
        type: NgModule,
        args: [{}]
    }], null, null); })();
