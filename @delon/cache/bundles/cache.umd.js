...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('date-fns/addSeconds'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/platform'), require('@delon/util'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('@delon/cache', ['exports', '@angular/core', 'date-fns/addSeconds', 'rxjs', 'rxjs/operators', '@angular/cdk/platform', '@delon/util', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.cache = {}), global.ng.core, global.addSeconds, global.rxjs, global.rxjs.operators, global.ng.cdk.platform, global.delon.util, global.ng.common.http));
