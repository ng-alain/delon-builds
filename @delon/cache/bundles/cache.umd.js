...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('date-fns/addSeconds'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/platform'), require('@delon/util/config'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('@delon/cache', ['exports', '@angular/core', 'date-fns/addSeconds', 'rxjs', 'rxjs/operators', '@angular/cdk/platform', '@delon/util/config', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.cache = {}), global.ng.core, global.addSeconds, global.rxjs, global.rxjs.operators, global.ng.cdk.platform, global.i1, global.ng.common.http));
}(this, (function (exports, i0, addSeconds, rxjs, operators, platform, i1, i2) { 'use strict';
    ...
    /** @nocollapse */ CacheService.ɵfac = function CacheService_Factory(t) { return new (t || CacheService)(i0.ɵɵinject(i1.AlainConfigService), i0.ɵɵinject(DC_STORE_STORAGE_TOKEN), i0.ɵɵinject(i2.HttpClient)); };
    ...
    /** @nocollapse */ DelonCacheModule.ɵmod = i0.ɵɵdefineNgModule({ type: DelonCacheModule });
    /** @nocollapse */ DelonCacheModule.ɵinj = i0.ɵɵdefineInjector({ factory: function DelonCacheModule_Factory(t) { return new (t || DelonCacheModule)(); } });
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DelonCacheModule, [{
                type: i0.NgModule,
                args: [{}]
            }], null, null);
    })();
