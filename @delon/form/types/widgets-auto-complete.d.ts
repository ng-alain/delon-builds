...
export declare class AutoCompleteWidget extends ControlUIWidget<SFAutoCompleteWidgetSchema> {
  ...
  protected readonly i: import("@angular/core").WritableSignal<any>;
  protected readonly list: import("@angular/core").WritableSignal<Observable<SFSchemaEnum[]> | null>;
  protected readonly typing: import("@angular/core").WritableSignal<string>;
...
export declare function withAutoCompleteWidget(): SFWidgetProvideConfig;