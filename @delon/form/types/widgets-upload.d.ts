...
import { ControlUIWidget, SFSchemaEnumType, SFUISchemaItem, SFValue, SFWidgetProvideConfig, WidgetRegistry } from "@delon/form";
import * as i0 from "@angular/core";
import { OnInit } from "@angular/core";
import { NzSafeAny } from "ng-zorro-antd/core/types";
import * as i4 from "ng-zorro-antd/upload";
import { NzShowUploadList, NzUploadChangeParam, NzUploadFile, NzUploadXHRArgs, UploadFilter } from "ng-zorro-antd/upload";
...
export declare class UploadWidget extends ControlUIWidget<SFUploadWidgetSchema> implements OnInit {
  ...
  i: NzSafeAny;
  protected readonly fileList: import("@angular/core").WritableSignal<NzUploadFile[]>;
  btnType: string;
  ngOnInit(): void;
  change(args: NzUploadChangeParam): void;
...
export declare function withUploadWidget(): SFWidgetProvideConfig;