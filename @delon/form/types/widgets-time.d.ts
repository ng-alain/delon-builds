...
import { ControlUIWidget, SFDLSSize, SFUISchemaItem, SFValue, SFWidgetProvideConfig, WidgetRegistry } from "@delon/form";
...
export declare class TimeWidget extends ControlUIWidget<SFTimeWidgetSchema> implements OnInit {
  ...
  private valueFormat;
  protected readonly displayValue: import("@angular/core").WritableSignal<Date | null>;
  i: NzSafeAny;
  ngOnInit(): void;
...
export declare function withTimeWidget(): SFWidgetProvideConfig;