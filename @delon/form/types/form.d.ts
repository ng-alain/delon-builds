...
declare namespace sf_item_component_d_exports {
  export { SFItemComponent };
}
export declare class SFItemComponent implements OnInit, OnDestroy {
  private readonly widgetFactory;
  private readonly terminator;
  readonly destroy$: Subject<void>;
  widget: Widget<FormProperty, SFUISchemaItem> | null;
  readonly formProperty: import("@angular/core").InputSignal<FormProperty>;
  readonly footer: import("@angular/core").InputSignal<TemplateRef<void> | null>;
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<SFItemComponent, "sf-item", ["sfItem"], {
    "formProperty": {
      "alias": "formProperty";
      "required": true;
      "isSignal": true;
...
declare namespace object_widget_d_exports {
  export { ObjectWidget };
}
export declare class ObjectWidget extends ObjectLayoutWidget implements OnInit {
  ...
  title?: string;
  showExpand: boolean;
  protected readonly expand: import("@angular/core").WritableSignal<boolean>;
  ngOnInit(): void;
  changeExpand(): void;
...
declare namespace string_widget_d_exports {
  export { StringWidget };
}
...
declare namespace number_widget_d_exports {
  export { NumberWidget };
}
...
declare namespace date_widget_d_exports {
  export { DateWidget };
}
export declare class DateWidget extends ControlUIWidget<SFDateWidgetSchema> implements OnInit {
  ...
  private flatRange;
  mode: string;
  protected readonly displayValue: import("@angular/core").WritableSignal<Date | Date[] | null>;
  displayFormat: string;
  i: {
    allowClear: boolean;
    showToday: boolean;
...
declare namespace radio_widget_d_exports {
  export { RadioWidget };
}
export declare class RadioWidget extends ControlUIWidget<SFRadioWidgetSchema> {
  ...
  protected readonly styleType: import("@angular/core").WritableSignal<boolean>;
  reset(value: SFValue): void;
...
declare namespace checkbox_widget_d_exports {
  export { CheckboxWidget };
}
export declare class CheckboxWidget extends ControlUIWidget<SFCheckboxWidgetSchema> {
  protected readonly data: import("@angular/core").WritableSignal<SFSchemaEnum[]>;
  protected readonly allChecked: import("@angular/core").WritableSignal<boolean>;
  protected readonly indeterminate: import("@angular/core").WritableSignal<boolean>;
  protected readonly grid_span: import("@angular/core").WritableSignal<number>;
  protected readonly labelTitle: import("@angular/core").WritableSignal<string>;
  protected readonly inited: import("@angular/core").WritableSignal<boolean>;
  reset(value: SFValue): void;
  _setValue(value: SFValue): void;
  notifySet(): void;
...
declare namespace boolean_widget_d_exports {
...
declare namespace textarea_widget_d_exports {
...
declare namespace select_widget_d_exports {
  export { SelectWidget };
}
export declare class SelectWidget extends ControlUIWidget<SFSelectWidgetSchema> implements OnInit {
  ...
  protected readonly data: import("@angular/core").WritableSignal<SFSchemaEnum[]>;
  protected readonly _value: import("@angular/core").WritableSignal<any>;
  protected readonly loading: import("@angular/core").WritableSignal<boolean>;
  /** 模板读取，且在异步 `checkGroup()` 中写入，必须是 signal 才能保证 OnPush 刷新 */
  protected readonly hasGroup: import("@angular/core").WritableSignal<boolean>;
  private checkGroup;
  ngOnInit(): void;
  reset(value: SFValue): void;
...
declare namespace text_widget_d_exports {
  export { TextWidget };
}
export declare class TextWidget extends ControlUIWidget<SFTextWidgetSchema> implements OnInit {
  protected readonly text: import("@angular/core").WritableSignal<string>;
  ngOnInit(): void;
  reset(value: SFValue): void;
...
export declare class SFTemplateDirective implements OnInit {
  ...
  static ɵdir: i0.ɵɵDirectiveDeclaration<SFTemplateDirective, "[sf-template]", never, {
    "path": {
      "alias": "sf-template";
      "required": true;
      "isSignal": true;
...
export declare class NzWidgetRegistry extends WidgetRegistry {
  constructor();
}
...
export declare class ArrayLayoutWidget extends Widget<ArrayProperty, SFArrayWidgetSchema> {
...
export declare class ObjectLayoutWidget extends Widget<ObjectProperty, SFObjectWidgetSchema> {
  protected readonly displayError = false;
  reset(_value: SFValue): void;
  afterViewInit(): void;
...
declare namespace sf_component_d_exports {
  export { SFComponent, useFactory };
}
...
export declare class SFComponent implements OnInit, OnChanges, OnDestroy, AfterViewInit {
  ...
  readonly layoutInput: import("@angular/core").InputSignal<SFLayout | undefined>;
  readonly layout: import("@angular/core").WritableSignal<SFLayout>;
  /** JSON Schema */
  readonly schemaInput: import("@angular/core").InputSignal<SFSchema | undefined>;
  /**
  ...
  /** UI Schema */
  readonly uiInput: import("@angular/core").InputSignal<SFUISchema | undefined>;
  /**
  ...
  /** 表单默认值 */
  readonly formData: import("@angular/core").InputSignal<Record<string, any> | undefined>;
  /**
   * 按钮
   ...
   */
  readonly button: import("@angular/core").InputSignal<SFButton | "none" | null | undefined>;
  /**
   * 是否实时校验，默认：`true`
   * - `true` 每一次都校验
   * - `false` 提交时校验
   */
  readonly liveValidateInput: import("@angular/core").InputSignal<unknown>;
  readonly liveValidate: import("@angular/core").WritableSignal<boolean>;
  /**
   * 指定表单 `autocomplete` 值
   *
   * 未绑定时回落到全局配置 `options.autocomplete`
   */
  readonly autocompleteInput: import("@angular/core").InputSignal<"on" | "off" | undefined>;
  readonly autocomplete: import("@angular/core").Signal<"on" | "off">;
  /**
   * Whether to display error visuals immediately
   *
   * 是否立即显示错误视觉
   */
  readonly firstVisualInput: import("@angular/core").InputSignal<unknown>;
  readonly firstVisual: import("@angular/core").WritableSignal<boolean>;
  /**
   * Whether to only display error visuals but not error text
   *
   * 是否只展示错误视觉不显示错误文本
   */
  readonly onlyVisual: import("@angular/core").InputSignalWithTransform<boolean, unknown>;
  readonly compact: import("@angular/core").InputSignalWithTransform<boolean, unknown>;
  /**
   ...
   */
  readonly mode: import("@angular/core").InputSignal<SFMode | undefined>;
  ...
  readonly cleanValue: import("@angular/core").InputSignalWithTransform<boolean, unknown>;
  readonly delayInput: import("@angular/core").InputSignal<unknown>;
  readonly delay: import("@angular/core").WritableSignal<boolean>;
  readonly formValueChange: import("@angular/core").OutputEmitterRef<SFValueChange>;
  readonly formChange: import("@angular/core").OutputEmitterRef<Record<string, unknown>>;
  readonly formSubmit: import("@angular/core").OutputEmitterRef<Record<string, unknown>>;
  readonly formReset: import("@angular/core").OutputEmitterRef<Record<string, unknown>>;
  readonly formError: import("@angular/core").OutputEmitterRef<ErrorData[]>;
  /**
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<SFComponent, "sf, [sf]", ["sf"], {
    "expandable": {
      "alias": "expandable";
      "required": false;
      "isSignal": true;
...
export declare class SFFixedDirective implements AfterViewInit, OnChanges {
  ...
  readonly num: import("@angular/core").InputSignalWithTransform<number, unknown>;
  private init;
  ngAfterViewInit(): void;
  ngOnChanges(): void;
  static ɵfac: i0.ɵɵFactoryDeclaration<SFFixedDirective, never>;
  static ɵdir: i0.ɵɵDirectiveDeclaration<SFFixedDirective, "[fixed-label]", never, {
    "num": {
      "alias": "fixed-label";
      "required": false;
      "isSignal": true;
...
export declare class SFItemWrapComponent {
  ...
  readonly schema: import("@angular/core").InputSignal<SFSchema>;
  readonly ui: import("@angular/core").InputSignal<SFUISchemaItem>;
  readonly showError: import("@angular/core").InputSignal<boolean | undefined>;
  readonly error: import("@angular/core").InputSignal<string | undefined>;
  readonly showTitle: import("@angular/core").InputSignal<string | boolean | null | undefined>;
  readonly title: import("@angular/core").InputSignal<string | null>;
  protected readonly t: import("@angular/core").Signal<string>;
  protected readonly oh: import("@angular/core").Signal<SFOptionalHelp>;
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<SFItemWrapComponent, "sf-item-wrap", never, {
    "id": {
      "alias": "id";
      "required": false;
      "isSignal": true;
