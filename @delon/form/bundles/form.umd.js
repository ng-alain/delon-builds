    ...
    ***************************************************************************** */
            ...
            var inFn = function (schema, _parentSchema, uiSchema, parentUiSchema, uiRes) {
                ...
                Object.keys(schema.properties).forEach(function (key) {
                    ...
                    if (property.description) {
                        ui._description = _this.dom.bypassSecurityTrustHtml(property.description);
                    }
    ...
    var SFFixedDirective = /** @class */ (function () {
        ...
        SFFixedDirective.prototype.init = function () {
            ...
            var controlEl = widgetEl.querySelector('nz-col.ant-form-item-control-wrapper,.ant-form-item-control');
