...
var QrCodeWidget = class QrCodeWidget extends ControlUIWidget {
	static KEY = "qr-code";
	refresh(qr) {
		this.setValue(qr);
		this.ui.refresh?.(qr);
...
var QrCodeWidgetModule = class QrCodeWidgetModule {
