...
var RateWidget = class RateWidget extends ControlUIWidget {
	static KEY = "rate";
	count;
	allowHalf;
	allowClear;
	...
	ngOnInit() {
		...
		this.allowHalf = (schema.multipleOf ?? .5) === .5;
...
var RateWidgetModule = class RateWidgetModule {
