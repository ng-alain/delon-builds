...
var TinymceWidget = class TinymceWidget extends ControlUIWidget {
	static KEY = "tinymce";
	change(value) {
		this.setValue(value);
...
var TinymceWidgetModule = class TinymceWidgetModule {
