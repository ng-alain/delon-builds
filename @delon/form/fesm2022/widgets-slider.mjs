...
var SliderWidget = class SliderWidget extends ControlUIWidget {
	static KEY = "slider";
	min;
	max;
	step;
	...
	ngOnInit() {
		...
		this.step = this.ui.step === void 0 ? multipleOf ?? 1 : this.ui.step;
...
var SliderWidgetModule = class SliderWidgetModule {
