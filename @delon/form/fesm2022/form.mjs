...
class SFComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.1.0", ngImport: i0, type: SFComponent, deps: [{ token: i1$1.AlainConfigService }], target: i0.ɵɵFactoryTarget.Component }); }
