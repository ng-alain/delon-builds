...
var TimeWidget = class TimeWidget extends ControlUIWidget {
	static KEY = "time";
	valueFormat;
	...
	ngOnInit() {
		...
		const opt = {
			...
			defaultOpenValue: ui.defaultOpenValue ?? /* @__PURE__ */ new Date(),
		...
		if (opt.use12Hours && !ui.displayFormat) opt.displayFormat = `h:mm:ss a`;
		this.i = opt;
	}
	reset(value) {
		...
		if (v != null && v.toString() === "Invalid Date") {
			...
			v = /* @__PURE__ */ new Date(`1970-1-1 ${value}`);
		}
...
var TimeWidgetModule = class TimeWidgetModule {
