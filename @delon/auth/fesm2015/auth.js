...
import { InjectionToken, inject, ɵɵinject, ɵɵdefineInjectable, ɵsetClassMetadata, Injectable, Inject, Injector, Optional, ɵɵgetInheritedFactory, ɵɵdefineNgModule, ɵɵdefineInjector, NgModule } from '@angular/core';
...
/** @nocollapse */ TokenService.ɵfac = function TokenService_Factory(t) { return new (t || TokenService)(ɵɵinject(AlainConfigService), ɵɵinject(DA_STORE_TOKEN)); };
/** @nocollapse */ TokenService.ɵprov = ɵɵdefineInjectable({ token: TokenService, factory: TokenService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(TokenService, [{
        type: Injectable
...
/** @nocollapse */ SocialService.ɵfac = function SocialService_Factory(t) { return new (t || SocialService)(ɵɵinject(DA_SERVICE_TOKEN), ɵɵinject(DOCUMENT), ɵɵinject(Router)); };
/** @nocollapse */ SocialService.ɵprov = ɵɵdefineInjectable({ token: SocialService, factory: SocialService.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SocialService, [{
        type: Injectable
...
/** @nocollapse */ BaseInterceptor.ɵfac = function BaseInterceptor_Factory(t) { return new (t || BaseInterceptor)(ɵɵinject(Injector, 8)); };
/** @nocollapse */ BaseInterceptor.ɵprov = ɵɵdefineInjectable({ token: BaseInterceptor, factory: BaseInterceptor.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(BaseInterceptor, [{
        type: Injectable
...
/** @nocollapse */ JWTInterceptor.ɵprov = ɵɵdefineInjectable({ token: JWTInterceptor, factory: JWTInterceptor.ɵfac });
const ɵJWTInterceptor_BaseFactory = /*@__PURE__*/ ɵɵgetInheritedFactory(JWTInterceptor);
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(JWTInterceptor, [{
        type: Injectable
    }], null, null); })();
...
/** @nocollapse */ JWTGuard.ɵfac = function JWTGuard_Factory(t) { return new (t || JWTGuard)(ɵɵinject(DA_SERVICE_TOKEN), ɵɵinject(Injector)); };
/** @nocollapse */ JWTGuard.ɵprov = ɵɵdefineInjectable({ token: JWTGuard, factory: JWTGuard.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(JWTGuard, [{
        type: Injectable,
...
/** @nocollapse */ SimpleInterceptor.ɵprov = ɵɵdefineInjectable({ token: SimpleInterceptor, factory: SimpleInterceptor.ɵfac });
const ɵSimpleInterceptor_BaseFactory = /*@__PURE__*/ ɵɵgetInheritedFactory(SimpleInterceptor);
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SimpleInterceptor, [{
        type: Injectable
    }], null, null); })();
...
/** @nocollapse */ SimpleGuard.ɵfac = function SimpleGuard_Factory(t) { return new (t || SimpleGuard)(ɵɵinject(DA_SERVICE_TOKEN), ɵɵinject(Injector)); };
/** @nocollapse */ SimpleGuard.ɵprov = ɵɵdefineInjectable({ token: SimpleGuard, factory: SimpleGuard.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(SimpleGuard, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: undefined, decorators: [{
                type: Inject,
...
/** @nocollapse */ DelonAuthModule.ɵmod = ɵɵdefineNgModule({ type: DelonAuthModule });
/** @nocollapse */ DelonAuthModule.ɵinj = ɵɵdefineInjector({ factory: function DelonAuthModule_Factory(t) { return new (t || DelonAuthModule)(); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(DelonAuthModule, [{
        type: NgModule,
        args: [{}]
    }], null, null); })();
