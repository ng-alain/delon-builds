...
import { ɵɵinject, LOCALE_ID, ɵɵdefineInjectable, ɵsetClassMetadata, Injectable, Inject } from '@angular/core';
...
/** @nocollapse */ CurrencyService.ɵfac = function CurrencyService_Factory(t) { return new (t || CurrencyService)(ɵɵinject(AlainConfigService), ɵɵinject(LOCALE_ID)); };
/** @nocollapse */ CurrencyService.ɵprov = ɵɵdefineInjectable({ token: CurrencyService, factory: CurrencyService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(CurrencyService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: AlainConfigService }, { type: undefined, decorators: [{
                type: Inject,
                args: [LOCALE_ID]
            }] }]; }, null); })();
