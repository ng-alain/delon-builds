...
import { EnvironmentProviders, InjectionToken, TemplateRef, TrackByFunction } from "@angular/core";
...
export interface AlainDateRangePickerShortcut {
   ...
   */
  list?: Array<AlainDateRangePickerShortcutItem | 'today' | 'yesterday' | '-3' | '-7' | 'week' | 'lastWeek' | 'month' | 'lastMonth' | 'year'>;
}
...
export interface AlainThemeI18nConfig {
  /**
...
export type AlainThemePipeDateFormatCustom = (value: Date, formatString?: string | null, options?: {
  locale?: Locale;
}) => string;
