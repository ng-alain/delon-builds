...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@delon/util'), require('@delon/theme'), require('ng-zorro-antd/tooltip'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@delon/chart/mini-progress', ['exports', '@angular/core', '@delon/util', '@delon/theme', 'ng-zorro-antd/tooltip', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.chart = global.delon.chart || {}, global.delon.chart['mini-progress'] = {}), global.ng.core, global.delon.util, global.delon.theme, global['ng-zorro-antd/tooltip'], global.ng.common));
}(this, (function (exports, i0, util, i1, i2, i3) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ G2MiniProgressModule.ɵinj = i0.ɵɵdefineInjector({ factory: function G2MiniProgressModule_Factory(t) { return new (t || G2MiniProgressModule)(); }, imports: [[i3.CommonModule, util.DelonUtilModule, i1.DelonLocaleModule, i2.NzToolTipModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(G2MiniProgressModule, { declarations: [G2MiniProgressComponent], imports: [i3.CommonModule, util.DelonUtilModule, i1.DelonLocaleModule, i2.NzToolTipModule], exports: [G2MiniProgressComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(G2MiniProgressModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [i3.CommonModule, util.DelonUtilModule, i1.DelonLocaleModule, i2.NzToolTipModule],
