...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@delon/chart/core'), require('@delon/util'), require('date-fns/format'), require('ng-zorro-antd/core/outlet'), require('@angular/common'), require('ng-zorro-antd/skeleton')) :
    typeof define === 'function' && define.amd ? define('@delon/chart/timeline', ['exports', '@angular/core', '@delon/chart/core', '@delon/util', 'date-fns/format', 'ng-zorro-antd/core/outlet', '@angular/common', 'ng-zorro-antd/skeleton'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.chart = global.delon.chart || {}, global.delon.chart.timeline = {}), global.ng.core, global.delon.chart.core, global.delon.util, global.format, global['ng-zorro-antd/core/outlet'], global.ng.common, global.i3));
}(this, (function (exports, i0, core, util, format, i1, i2, i3) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var G2TimelineComponent = /** @class */ (function (_super) {
        ...
        G2TimelineComponent.prototype.attachChart = function () {
            ...
            data = data
                .map(function (item) {
                item.time = util.toDate(item.time);
    ...
    /** @nocollapse */ G2TimelineModule.ɵinj = i0.ɵɵdefineInjector({ factory: function G2TimelineModule_Factory(t) { return new (t || G2TimelineModule)(); }, imports: [[i2.CommonModule, util.DelonUtilModule, i1.NzOutletModule, i3.NzSkeletonModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(G2TimelineModule, { declarations: [G2TimelineComponent], imports: [i2.CommonModule, util.DelonUtilModule, i1.NzOutletModule, i3.NzSkeletonModule], exports: [G2TimelineComponent] }); })();
    (function () {
