...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@delon/util'), require('ng-zorro-antd/card'), require('ng-zorro-antd/spin'), require('ng-zorro-antd/core/outlet'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@delon/chart/card', ['exports', '@angular/core', '@delon/util', 'ng-zorro-antd/card', 'ng-zorro-antd/spin', 'ng-zorro-antd/core/outlet', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.chart = global.delon.chart || {}, global.delon.chart.card = {}), global.ng.core, global.delon.util, global['ng-zorro-antd/card'], global['ng-zorro-antd/spin'], global['ng-zorro-antd/core/outlet'], global.ng.common));
}(this, (function (exports, i0, util, i1, i2, i3, i4) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ G2CardModule.ɵinj = i0.ɵɵdefineInjector({ factory: function G2CardModule_Factory(t) { return new (t || G2CardModule)(); }, imports: [[i4.CommonModule, util.DelonUtilModule, i1.NzCardModule, i2.NzSpinModule, i3.NzOutletModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(G2CardModule, { declarations: [G2CardComponent], imports: [i4.CommonModule, util.DelonUtilModule, i1.NzCardModule, i2.NzSpinModule, i3.NzOutletModule], exports: [G2CardComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(G2CardModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [i4.CommonModule, util.DelonUtilModule, i1.NzCardModule, i2.NzSpinModule, i3.NzOutletModule],
