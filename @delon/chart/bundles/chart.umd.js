...
(function (global, factory) {
    ...
    var DelonChartModule = /** @class */ (function () {
        function DelonChartModule() {
            util.warnDeprecation("The `DelonChartModule` has been deprecated and will be removed in 12.0.0. Please use secondary entry instead.\ne.g. `import { G2BarModule } from '@delon/chart/bar';`");
        }
        return DelonChartModule;
    }());
    /** @nocollapse */ DelonChartModule.ɵmod = i0.ɵɵdefineNgModule({ type: DelonChartModule });
    /** @nocollapse */ DelonChartModule.ɵinj = i0.ɵɵdefineInjector({ factory: function DelonChartModule_Factory(t) { return new (t || DelonChartModule)(); }, imports: [bar.G2BarModule,
            card.G2CardModule,
            custom.G2CustomModule,
            gauge.G2GaugeModule,
            miniArea.G2MiniAreaModule,
            ...
            trend.TrendModule] });
    (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(DelonChartModule, { exports: [bar.G2BarModule,
                card.G2CardModule,
                custom.G2CustomModule,
                gauge.G2GaugeModule,
                miniArea.G2MiniAreaModule,
    ...
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DelonChartModule, [{
                type: i0.NgModule,
