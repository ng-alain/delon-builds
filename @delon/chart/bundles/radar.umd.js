...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@delon/chart/core'), require('@delon/util/decorator'), require('@angular/common'), require('ng-zorro-antd/skeleton'), require('ng-zorro-antd/core/outlet'), require('ng-zorro-antd/grid')) :
    typeof define === 'function' && define.amd ? define('@delon/chart/radar', ['exports', '@angular/core', '@delon/chart/core', '@delon/util/decorator', '@angular/common', 'ng-zorro-antd/skeleton', 'ng-zorro-antd/core/outlet', 'ng-zorro-antd/grid'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.chart = global.delon.chart || {}, global.delon.chart.radar = {}), global.ng.core, global.delon.chart.core, global.decorator, global.ng.common, global.i2, global['ng-zorro-antd/core/outlet'], global['ng-zorro-antd/grid']));
    ...
    ***************************************************************************** */
    ...
    /** @nocollapse */ G2RadarModule.ɵinj = i0.ɵɵdefineInjector({ factory: function G2RadarModule_Factory(t) { return new (t || G2RadarModule)(); }, imports: [[i1.CommonModule, i4.NzGridModule, i3.NzOutletModule, i2.NzSkeletonModule]] });
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(G2RadarModule, { declarations: [G2RadarComponent], imports: [i1.CommonModule, i4.NzGridModule, i3.NzOutletModule, i2.NzSkeletonModule], exports: [G2RadarComponent] }); })();
    (function () {
        (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(G2RadarModule, [{
                type: i0.NgModule,
                args: [{
                        imports: [i1.CommonModule, i4.NzGridModule, i3.NzOutletModule, i2.NzSkeletonModule],
