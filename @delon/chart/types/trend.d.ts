...
declare namespace trend_component_d_exports {
  export { TrendComponent };
}
export declare class TrendComponent {
  /** 上升下降标识 */
  readonly flag: import("@angular/core").InputSignal<"up" | "down" | undefined>;
  /** 是否彩色标记 */
  readonly colorful: import("@angular/core").InputSignalWithTransform<boolean, unknown>;
  /** 颜色反转 */
  readonly reverseColor: import("@angular/core").InputSignalWithTransform<boolean, unknown>;
  static ɵfac: i0.ɵɵFactoryDeclaration<TrendComponent, never>;
  static ɵcmp: i0.ɵɵComponentDeclaration<TrendComponent, "trend", ["trend"], {
    "flag": {
      "alias": "flag";
      "required": false;
      "isSignal": true;
