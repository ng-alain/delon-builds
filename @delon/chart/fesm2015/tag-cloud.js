...
/** @nocollapse */ G2TagCloudComponent.ɵcmp = ɵɵngDeclareComponent({ version: "11.1.1", type: G2TagCloudComponent, selector: "g2-tag-cloud", inputs: { width: "width", height: "height", padding: "padding", data: "data" }, outputs: { clickItem: "clickItem" }, exportAs: ["g2TagCloud"], usesInheritance: true, ngImport: i0, template: `<nz-skeleton *ngIf="!loaded"></nz-skeleton>`, isInline: true, directives: [{ type: NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { type: NzSkeletonComponent, selector: "nz-skeleton", inputs: ["nzActive", "nzLoading", "nzRound", "nzTitle", "nzAvatar", "nzParagraph"], exportAs: ["nzSkeleton"] }], changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None });
__decorate([
    InputNumber(),
...
const ɵG2TagCloudComponent_BaseFactory = /*@__PURE__*/ ɵɵgetInheritedFactory(G2TagCloudComponent);
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(G2TagCloudComponent, [{
        type: Component,
        args: [{
...
/** @nocollapse */ G2TagCloudModule.ɵmod = ɵɵdefineNgModule({ type: G2TagCloudModule });
/** @nocollapse */ G2TagCloudModule.ɵinj = ɵɵdefineInjector({ factory: function G2TagCloudModule_Factory(t) { return new (t || G2TagCloudModule)(); }, imports: [[CommonModule, DelonUtilModule, NzSkeletonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(G2TagCloudModule, { declarations: [G2TagCloudComponent], imports: [CommonModule, DelonUtilModule, NzSkeletonModule], exports: [G2TagCloudComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassMetadata(G2TagCloudModule, [{
        type: NgModule,
        args: [{
