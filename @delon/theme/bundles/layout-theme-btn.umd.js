...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/cdk/bidi'), require('@angular/cdk/platform'), require('@angular/common'), require('@angular/core'), require('@delon/util/config'), require('@ngneat/until-destroy'), require('ng-zorro-antd/dropdown'), require('ng-zorro-antd/tooltip')) :
    typeof define === 'function' && define.amd ? define('@delon/theme/theme-btn', ['exports', '@angular/cdk/bidi', '@angular/cdk/platform', '@angular/common', '@angular/core', '@delon/util/config', '@ngneat/until-destroy', 'ng-zorro-antd/dropdown', 'ng-zorro-antd/tooltip'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.theme = global.delon.theme || {}, global.delon.theme['theme-btn'] = {}), global.ng.cdk.bidi, global.ng.cdk.platform, global.ng.common, global.ng.core, global.config, global.untilDestroy, global.dropdown, global.tooltip));
}(this, (function (exports, bidi, platform, common, core, config, untilDestroy, dropdown, tooltip) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.ThemeBtnComponent = /** @class */ (function () {
    ...
    exports.ThemeBtnComponent.decorators = [
    ...
    /** @nocollapse */
    exports.ThemeBtnComponent.ctorParameters = function () { return [
        { type: core.Renderer2 },
    ...
    exports.ThemeBtnComponent.propDecorators = {
        types: [{ type: core.Input }],
        devTips: [{ type: core.Input }]
    };
    exports.ThemeBtnComponent = __decorate([
        untilDestroy.UntilDestroy(),
        __metadata("design:paramtypes", [core.Renderer2,
            config.AlainConfigService,
            platform.Platform, Object, bidi.Directionality])
    ], exports.ThemeBtnComponent);

    var COMPONENTS = [exports.ThemeBtnComponent];
