...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/router'), require('@delon/theme'), require('@delon/util/browser'), require('@ngneat/until-destroy'), require('ng-zorro-antd/message'), require('ng-zorro-antd/avatar'), require('ng-zorro-antd/dropdown'), require('ng-zorro-antd/icon'), require('ng-zorro-antd/tooltip'), require('@angular/cdk/bidi'), require('@angular/platform-browser'), require('@delon/util/decorator'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@delon/theme/layout-default', ['exports', '@angular/common', '@angular/core', '@angular/router', '@delon/theme', '@delon/util/browser', '@ngneat/until-destroy', 'ng-zorro-antd/message', 'ng-zorro-antd/avatar', 'ng-zorro-antd/dropdown', 'ng-zorro-antd/icon', 'ng-zorro-antd/tooltip', '@angular/cdk/bidi', '@angular/platform-browser', '@delon/util/decorator', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.theme = global.delon.theme || {}, global.delon.theme['layout-default'] = {}), global.ng.common, global.ng.core, global.ng.router, global.delon.theme, global.browser, global.untilDestroy, global.message, global.avatar, global.dropdown, global.icon, global.tooltip, global.ng.cdk.bidi, global.ng.platformBrowser, global.decorator, global.rxjs.operators));
}(this, (function (exports, common, core, router, theme, browser, untilDestroy, message, avatar, dropdown, icon, tooltip, bidi, platformBrowser, decorator, operators) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.LayoutDefaultComponent = /** @class */ (function () {
        function LayoutDefaultComponent(router$1, msgSrv, settings, el, renderer, doc) {
            ...
            router$1.events.pipe(untilDestroy.untilDestroyed(this)).subscribe(function (evt) {
        ...
        LayoutDefaultComponent.prototype.ngOnInit = function () {
            ...
            this.settings.notify.pipe(untilDestroy.untilDestroyed(this)).subscribe(function () { return _this.setClass(); });
            this.setClass();
        };
        return LayoutDefaultComponent;
    }());
    exports.LayoutDefaultComponent.decorators = [
        { type: core.Component, args: [{
    ...
    /** @nocollapse */
    exports.LayoutDefaultComponent.ctorParameters = function () { return [
        { type: router.Router },
    ...
    exports.LayoutDefaultComponent.propDecorators = {
    ...
    exports.LayoutDefaultHeaderComponent = /** @class */ (function () {
        ...
        LayoutDefaultHeaderComponent.prototype.ngAfterViewInit = function () {
            var _this = this;
            this.parent.headerItems.changes.pipe(untilDestroy.untilDestroyed(this)).subscribe(function () { return _this.refresh(); });
            this.refresh();
        };
    ...
    exports.LayoutDefaultHeaderComponent.decorators = [
        { type: core.Component, args: [{
    ...
    /** @nocollapse */
    exports.LayoutDefaultHeaderComponent.ctorParameters = function () { return [
        { type: theme.SettingsService },
        { type: exports.LayoutDefaultComponent },
        { type: core.ChangeDetectorRef }
    ]; };
    exports.LayoutDefaultHeaderComponent = __decorate([
        untilDestroy.UntilDestroy(),
        __metadata("design:paramtypes", [theme.SettingsService, exports.LayoutDefaultComponent, core.ChangeDetectorRef])
    ], exports.LayoutDefaultHeaderComponent);

    var SHOWCLS = 'sidebar-nav__floating-show';
    var FLOATINGCLS = 'sidebar-nav__floating';
    exports.LayoutDefaultNavComponent = /** @class */ (function () {
    ...
    exports.LayoutDefaultNavComponent.decorators = [
        { type: core.Component, args: [{
    ...
    /** @nocollapse */
    exports.LayoutDefaultNavComponent.ctorParameters = function () { return [
    ...
    exports.LayoutDefaultNavComponent.propDecorators = {
    ...
    ], exports.LayoutDefaultNavComponent.prototype, "disabledAcl", void 0);
    __decorate([
        decorator.InputBoolean(),
        __metadata("design:type", Object)
    ], exports.LayoutDefaultNavComponent.prototype, "autoCloseUnderPad", void 0);
    __decorate([
        decorator.InputBoolean(),
        __metadata("design:type", Object)
    ], exports.LayoutDefaultNavComponent.prototype, "recursivePath", void 0);
    __decorate([
        decorator.InputBoolean(),
        __metadata("design:type", Object)
    ], exports.LayoutDefaultNavComponent.prototype, "openStrictly", void 0);
    __decorate([
        decorator.InputNumber(),
        __metadata("design:type", Object)
    ], exports.LayoutDefaultNavComponent.prototype, "maxLevelIcon", void 0);
    exports.LayoutDefaultNavComponent = __decorate([
        untilDestroy.UntilDestroy(),
        __metadata("design:paramtypes", [theme.MenuService,
            ...
            core.NgZone,
            platformBrowser.DomSanitizer, Object, bidi.Directionality])
    ], exports.LayoutDefaultNavComponent);
