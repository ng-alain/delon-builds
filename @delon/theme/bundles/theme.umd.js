...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@delon/acl'), require('@angular/common'), require('@angular/cdk/platform'), require('@delon/util/config'), require('@angular/cdk/bidi'), require('ng-zorro-antd/core/config'), require('@angular/router'), require('@angular/platform-browser'), require('@delon/util/other'), require('ng-zorro-antd/modal'), require('ng-zorro-antd/drawer'), require('@angular/common/http'), require('@delon/util/date-time'), require('date-fns/format'), require('date-fns/formatDistanceToNow'), require('ng-zorro-antd/i18n'), require('@angular/cdk/overlay'), require('@ant-design/icons-angular/icons'), require('ng-zorro-antd/icon')) :
    typeof define === 'function' && define.amd ? define('@delon/theme', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@delon/acl', '@angular/common', '@angular/cdk/platform', '@delon/util/config', '@angular/cdk/bidi', 'ng-zorro-antd/core/config', '@angular/router', '@angular/platform-browser', '@delon/util/other', 'ng-zorro-antd/modal', 'ng-zorro-antd/drawer', '@angular/common/http', '@delon/util/date-time', 'date-fns/format', 'date-fns/formatDistanceToNow', 'ng-zorro-antd/i18n', '@angular/cdk/overlay', '@ant-design/icons-angular/icons', 'ng-zorro-antd/icon'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.delon = global.delon || {}, global.delon.theme = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.delon.acl, global.ng.common, global.ng.cdk.platform, global.delon.util.config, global.ng.cdk.bidi, global.i3, global.ng.router, global.ng.platformBrowser, global.delon.util.other, global['ng-zorro-antd/modal'], global['ng-zorro-antd/drawer'], global.ng.common.http, global.delon.util['date-time'], global.format, global.formatDistanceToNow, global['ng-zorro-antd/i18n'], global.ng.cdk.overlay, global.icons, global['ng-zorro-antd/icon']));
}(this, (function (exports, i0, rxjs, operators, i1, common, i1$1, i1$2, i1$3, i3, router, i1$4, other, i1$5, i1$6, i1$7, dateTime, format, formatDistanceToNow, i1$8, overlay, icons, i1$9) { 'use strict';
