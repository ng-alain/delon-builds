...
class LayoutDefaultService {
     ...
     */
    setOptions(options) {
        this._options = Object.assign({ logoExpanded: `./assets/logo-full.svg`, logoCollapsed: `./assets/logo.svg`, logoLink: `/`, showHeaderCollapse: true, hideAside: false }, options);
    ...
    toggleCollapsed(status) {
        this.settings.setLayout('collapsed', status !== null && status !== void 0 ? status : !this.settings.layout.collapsed);
    }
}
