...
var SettingDrawerItemComponent = class SettingDrawerItemComponent {
	i = {};
	set data(val) {
		this.i = val;
		if (val.type === "px") this.pxVal = +val.value.replace("px", "");
	}
	pxVal = 0;
	pxChange(val) {
		this.i.value = `${val}px`;
	...
	static ɵfac = i0.ɵɵngDeclareFactory({
		...
		version: "22.2.0",
		ngImport: i0,
		type: SettingDrawerItemComponent,
		deps: [],
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: { data: "data" },
		host: { classAttribute: "setting-drawer__body-item" },
		ngImport: i0,
		template: `
    <span>
      {{ i.label }}
  ...
  `,
		...
		dependencies: [
			...
			{
				kind: "directive",
				type: i2.NzDrawerContentDirective,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  `,
	...
	propDecorators: { data: [{ type: Input }] }
});
...
var SettingDrawerComponent = class SettingDrawerComponent {
	...
	get cachedData() {
		return this.settingSrv.layout["alain-default-vars"] ?? {};
	}
	get DEFAULT_PRIMARY() {
	...
	async loadLess() {
		...
		return this.lazy.loadStyle("./assets/color.less", { rel: "stylesheet/less" }).then(() => {
	...
	genVars() {
		...
		const vars = { [`@primary-color`]: color };
...
var SettingDrawerModule = class SettingDrawerModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
		type: SettingDrawerModule,
		deps: [],
