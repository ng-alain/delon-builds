...
class ThemeBtnComponent {
    ...
    devTips = input(`When the dark.css file can't be found, you need to run it once: npm run theme`, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "devTips" }] : /* istanbul ignore next */ []));
    deployUrl = input('', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "deployUrl" }] : /* istanbul ignore next */ []));
    themeChange = output();
    constructor() {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: ThemeBtnComponent, decorators: [{
            type: Component,
            args: [{
                    selector: 'theme-btn',
                    template: `
...
class ThemeBtnModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: ThemeBtnModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.1.4", ngImport: i0, type: ThemeBtnModule, imports: [CommonModule, NzDropdownModule, NzTooltipModule, ThemeBtnComponent], exports: [ThemeBtnComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: ThemeBtnModule, imports: [CommonModule, NzDropdownModule, NzTooltipModule, COMPONENTS] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.4", ngImport: i0, type: ThemeBtnModule, decorators: [{
            type: NgModule,
            args: [{
