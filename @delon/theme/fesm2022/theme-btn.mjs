...
import { ChangeDetectionStrategy, Component, InjectionToken, NgModule, Renderer2, afterNextRender, inject, input, isDevMode, output } from "@angular/core";
...
var ThemeBtnComponent = class ThemeBtnComponent {
	doc = inject(DOCUMENT);
	...
	ngOnDestroy() {
		...
		if (el != null) this.doc.body.removeChild(el);
	}
	...
	static ɵcmp = i0.ɵɵngDeclareComponent({
		...
		inputs: {
			...
			deployUrl: {
				classPropertyName: "deployUrl",
				publicName: "deployUrl",
				isSignal: true,
				isRequired: false,
				transformFunction: null
			}
		},
		outputs: { themeChange: "themeChange" },
		host: {
			properties: { "class.theme-btn-rtl": "dir() === 'rtl'" },
			classAttribute: "theme-btn"
		},
		ngImport: i0,
		template: `
    <div
...
var ThemeBtnModule = class ThemeBtnModule {
	static ɵfac = i0.ɵɵngDeclareFactory({
		minVersion: "12.0.0",
		version: "22.2.0",
		ngImport: i0,
