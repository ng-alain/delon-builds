...
class LayoutDefaultHeaderItemComponent {
    host = viewChild('host', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "host" }] : /* istanbul ignore next */ []));
    hidden = input('none', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "hidden" }] : /* istanbul ignore next */ []));
    direction = input('right', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "direction" }] : /* istanbul ignore next */ []));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultHeaderItemComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.2.0", version: "22.1.7", type: LayoutDefaultHeaderItemComponent, isStandalone: true, selector: "layout-default-header-item", inputs: { hidden: { classPropertyName: "hidden", publicName: "hidden", isSignal: true, isRequired: false, transformFunction: null }, direction: { classPropertyName: "direction", publicName: "direction", isSignal: true, isRequired: false, transformFunction: null } }, viewQueries: [{ propertyName: "host", first: true, predicate: ["host"], descendants: true, isSignal: true }], ngImport: i0, template: `
    <ng-template #host>
      <ng-content />
    </ng-template>
  `, isInline: true });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultHeaderItemComponent, decorators: [{
            type: Component,
            args: [{
...
class LayoutDefaultService {
    ...
    options = signal(DEFAULT, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "options" }] : /* istanbul ignore next */ []));
    collapsedIcon = signal('', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "collapsedIcon" }] : /* istanbul ignore next */ []));
    constructor() {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultService, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultService, decorators: [{
            type: Injectable,
...
class LayoutDefaultHeaderComponent {
    ...
    left = computed(() => this.items().filter(i => i.direction() === 'left'), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "left" }] : /* istanbul ignore next */ []));
    middle = computed(() => this.items().filter(i => i.direction() === 'middle'), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "middle" }] : /* istanbul ignore next */ []));
    right = computed(() => this.items().filter(i => i.direction() === 'right'), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "right" }] : /* istanbul ignore next */ []));
    opt = this.srv.options;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultHeaderComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.1.7", type: LayoutDefaultHeaderComponent, isStandalone: true, selector: "layout-default-header", inputs: { items: { classPropertyName: "items", publicName: "items", isSignal: true, isRequired: true, transformFunction: null } }, host: { classAttribute: "alain-default__header" }, ngImport: i0, template: `
  ...
  `, isInline: true, dependencies: [{ kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "directive", type: RouterLink, selector: "[routerLink]", inputs: ["target", "queryParams", "fragment", "queryParamsHandling", "state", "info", "relativeTo", "preserveFragment", "skipLocationChange", "replaceUrl", "browserUrl", "routerLink"] }, { kind: "directive", type: NzIconDirective, selector: "nz-icon,[nz-icon]", inputs: ["nzType", "nzTheme", "nzTwotoneColor", "nzSpin", "nzRotate", "nzIconfont", "aria-label"], exportAs: ["nzIcon"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultHeaderComponent, decorators: [{
            type: Component,
            args: [{
...
class LayoutDefaultNavComponent {
    ...
    disabledAcl = input(false, { ...(ngDevMode ? { debugName: "disabledAcl" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    autoCloseUnderPad = input(true, { ...(ngDevMode ? { debugName: "autoCloseUnderPad" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    recursivePath = input(true, { ...(ngDevMode ? { debugName: "recursivePath" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    hideEmptyChildren = input(true, { ...(ngDevMode ? { debugName: "hideEmptyChildren" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    openStrictly = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "openStrictly" }] : /* istanbul ignore next */ []));
    maxLevelIcon = input(3, { ...(ngDevMode ? { debugName: "maxLevelIcon" } : /* istanbul ignore next */ {}), transform: numberAttribute });
    select = output();
    get collapsed() {
  ...
  `, isInline: true, dependencies: [{ kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "directive", type: NzIconDirective, selector: "nz-icon,[nz-icon]", inputs: ["nzType", "nzTheme", "nzTwotoneColor", "nzSpin", "nzRotate", "nzIconfont", "aria-label"], exportAs: ["nzIcon"] }, { kind: "directive", type: NzTooltipDirective, selector: "[nz-tooltip]", inputs: ["nzTooltipTitle", "nzTooltipTitleContext", "nz-tooltip", "nzTooltipTrigger", "nzTooltipPlacement", "nzTooltipOrigin", "nzTooltipVisible", "nzTooltipMouseEnterDelay", "nzTooltipMouseLeaveDelay", "nzTooltipOverlayClassName", "nzTooltipOverlayStyle", "nzTooltipArrowPointAtCenter", "nzTooltipColor"], outputs: ["nzTooltipVisibleChange"], exportAs: ["nzTooltip"] }, { kind: "component", type: NzBadgeComponent, selector: "nz-badge", inputs: ["nzShowZero", "nzShowDot", "nzStandalone", "nzDot", "nzOverflowCount", "nzColor", "nzStyle", "nzText", "nzTitle", "nzStatus", "nzCount", "nzOffset", "nzSize"], exportAs: ["nzBadge"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultNavComponent, decorators: [{
            type: Component,
            args: [{
...
class LayoutDefaultComponent {
    ...
    doc = inject(DOCUMENT);
    srv = inject(LayoutDefaultService);
    headerItems = contentChildren(LayoutDefaultHeaderItemComponent, { ...(ngDevMode ? { debugName: "headerItems" } : /* istanbul ignore next */ {}), descendants: false });
    opt = this.srv.options;
    layout = this.settings.layoutSignal;
    options = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "options" }] : /* istanbul ignore next */ []));
    asideUser = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "asideUser" }] : /* istanbul ignore next */ []));
    asideBottom = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "asideBottom" }] : /* istanbul ignore next */ []));
    nav = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "nav" }] : /* istanbul ignore next */ []));
    content = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "content" }] : /* istanbul ignore next */ []));
    customError = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "customError" }] : /* istanbul ignore next */ []));
    fetchingStrictly = input(false, { ...(ngDevMode ? { debugName: "fetchingStrictly" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    fetching = input(false, { ...(ngDevMode ? { debugName: "fetching" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    ...
    ...(ngDevMode ? [{ debugName: "showFetching" }] : /* istanbul ignore next */ []));
    constructor() {
        this.router.events
  ...
  `, isInline: true, dependencies: [{ kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "component", type: LayoutDefaultHeaderComponent, selector: "layout-default-header", inputs: ["items"] }, { kind: "component", type: LayoutDefaultNavComponent, selector: "layout-default-nav", inputs: ["disabledAcl", "autoCloseUnderPad", "recursivePath", "hideEmptyChildren", "openStrictly", "maxLevelIcon"], outputs: ["select"] }, { kind: "directive", type: NzIconDirective, selector: "nz-icon,[nz-icon]", inputs: ["nzType", "nzTheme", "nzTwotoneColor", "nzSpin", "nzRotate", "nzIconfont", "aria-label"], exportAs: ["nzIcon"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultComponent, decorators: [{
            type: Component,
            args: [{
...
class LayoutDefaultHeaderItemTriggerDirective {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultHeaderItemTriggerDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "22.1.7", type: LayoutDefaultHeaderItemTriggerDirective, isStandalone: true, selector: "[layout-default-header-item-trigger]", host: { classAttribute: "alain-default__nav-item" }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultHeaderItemTriggerDirective, decorators: [{
            type: Directive,
            args: [{
...
class LayoutDefaultModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultModule, imports: [CommonModule,
            RouterModule,
            NzTooltipModule,
            NzIconModule,
            NzAvatarModule,
            ...
            LayoutDefaultHeaderItemTriggerDirective,
            LayoutDefaultTopMenuItemComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultModule, imports: [CommonModule,
            RouterModule,
            NzTooltipModule,
            NzIconModule,
            NzAvatarModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.1.7", ngImport: i0, type: LayoutDefaultModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        CommonModule,
