...
import { OnDestroy, InjectionToken, Provider, Signal, PipeTransform, TemplateRef, Type, Injector, ModuleWithProviders, EnvironmentProviders, Version } from '@angular/core';
