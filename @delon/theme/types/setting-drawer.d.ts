...
declare namespace setting_drawer_item_component_d_exports {
...
export declare class SettingDrawerItemComponent {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<SettingDrawerItemComponent, "setting-drawer-item", never, {
    "data": {
      "alias": "data";
      "required": false;
    };
...
declare namespace setting_drawer_component_d_exports {
...
export declare class SettingDrawerComponent implements OnInit {
  ...
  static ɵcmp: i0.ɵɵComponentDeclaration<SettingDrawerComponent, "setting-drawer", never, {
    "autoApplyColor": {
      "alias": "autoApplyColor";
      "required": false;
    };
    "compilingText": {
      "alias": "compilingText";
